---
title: schedule-a-batch-smart-Kampagne-to-run-later
description: Stapelausführung einer intelligenten Kampagne für später planen
...
# Stapelausführung einer intelligenten Kampagne für später planen

<br> 

Nachdem Sie die Batch-Kampagne erstellt haben, können Sie sie jetzt oder später ausführen. Hier ist, wie man es später ausführen kann.
...
1. Wählen Sie die Zeitdauer aus, die die intelligente Kampagne ausgeführt werden soll (mindestens 15 Minuten vor der Ausführung). Klicken Sie außerhalb des Kalenders, um ihn zu schließen.

   ![Bild vier](/help/sky/assets/smart-campaigns/schedule-a-batch-smart-campaign-to-run-later/schedule-a-batch-smart-campaign-to-run-later-4.png)

1. Klicken Sie auf **[!UICONTROL Bestätigen]**.

   ![Bild fünf](/help/sky/assets/smart-campaigns/schedule-a-batch-smart-campaign-to-run-later/schedule-a-batch-smart-campaign-to-run-later-5.png)
