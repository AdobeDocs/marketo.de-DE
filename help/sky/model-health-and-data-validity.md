...
* **Schulungsstatus**: Zeigt an, ob Ihr Modell aktiv geschult wird (Verbesserung der Prognosen). Die Schulung findet automatisch alle 2 Wochen statt. Alle Modelle, die _verarbeitet_ werden, können bis zu 24 Stunden dauern. Bei _fehlgeschlagenen_ Modellen wenden Sie sich bitte an den [MarketingTo-Support](https://nation.marketo.com/t5/Support/ct-p/Support).
