...
Nachstehend finden Sie die alten Symbole der Benutzeroberfläche von Marketo Classic. Das aktuelle Symbolglossar kann [hier finden](/help/marketo/getting-started-2/things-to-know/icon-glossary.md){target="_blank"}.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Zielordner, der in einem anderen Arbeitsbereich freigegeben wurde <br>(Vorhängeschloss bedeutet, dass keine Änderungen vorgenommen werden können)</td> 
  </tr> 
  <tr> 
