...
Jetzt, da Sie alle [Ersteinrichtung](/help/marketo/getting-started-2/initial-setup/initial-setup-tasks.md), ist es Zeit, einige grundlegende Elemente zu etablieren, um eine reibungslose fortlaufende Nutzung zu gewährleisten. Dies wird die Grundlage für Ihr Journey mit Marketo Engage bilden und Ihnen dabei helfen, seine Funktionen optimal zu nutzen. Fangen wir an!

>[!NOTE]
>
>Sie können auch die Checkliste herunterladen [LINK EINFÜGEN] und überprüfen Sie die Schritte, während Sie gehen.
...
Nachdem Ihr Marketo Engage-Konto bereit ist, gehen Sie bitte in unsere [Best Practices für eine neue Marketo Engage-Instanz](/help/marketo/getting-started-2/implementing-a-new-marketo-engage-instance/where-to-start.md) , um Ihre Investition optimal zu nutzen und sich für langfristigen Erfolg zu etablieren.
