...
+ Produktdokumentationen {#product-docs}
   ...
   + CRM-Synch.{#crm-sync}
      ...
      + Veva CRM Sync {#veeva-crm-sync}
         + [Grundlagen zur VEC CRM-Synchronisierung](product-docs/crm-sync/salesforce-sync/understanding-the-veeva-crm-sync.md)
         + Einrichtung {#setup}
            ...
            + [Schritt 3 von 3: Marketo Engage und Salesforce verbinden (Professional)](product-docs/crm-sync/veeva-crm-sync/setup/step-3-of-3-connect-marketo-engage-and-salesforce.md)
         + Synchronisierungsdetails {#sync-details}
            ...
            + [Synchronisierung von Benutzerkonten](product-docs/crm-sync/veeva-crm-sync/sync-details/person-account-sync.md)
            ...
            + [Benutzerdefinierte Objektsynchronisierung in VEE CRM](product-docs/crm-sync/veeva-crm-sync/sync-details/veeva-crm-custom-object-sync.md)
   ...
   + Marketo Sales Insight {#marketo-sales-insight}
      + Aktionen {#actions}
         ...
         + Salesforce-Konfiguration {#salesforce-configuration}
            + [Konfiguration von Sales Insight-Aktionen in Salesforce](product-docs/marketo-sales-insight/actions/salesforce-configuration/sales-insight-actions-configuration-in-salesforce.md)
