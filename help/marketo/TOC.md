   ...
   + Nachfragegenerierung {#demand-generation}
      ...
      + Ereignisse {#events}
         ...
         + Interaktive Webinare {#interactive-webinars}
            + [Interaktive Webinare – Übersicht](product-docs/demand-generation/events/interactive-webinars/interactive-webinars-overview.md)
   ...
   + E-Mail-Marketing {#email-marketing}
      ...
      + Allgemein {#general}
         ...
         + Funktionen im Editor {#functions-in-the-editor}
            + [Link zum Weiterleiten an einen Freund in E-Mails](product-docs/email-marketing/general/functions-in-the-editor/forward-to-a-friend-link-in-emails.md)
...
+ Versionshinweise {#release-notes}
   ...
   + Frühere Versionen {#previous-releases}
      + 2025 {#2025}
         ...
         + [Versionshinweise: August &#39;25](release-notes/previous-releases/2025/release-notes-aug-25.md)
      + 2024 {#2024}
