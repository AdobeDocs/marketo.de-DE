...
+ Erste Schritte mit Marketo {#getting-started-with-marketo}
   ...
   + Setup {#setup}
      ...
      + [Checkliste einrichten](getting-started/setup-steps/setup-checklist.md)
   ...
   + Quick Wins {#quick-wins}
      ...
      + [Warnhinweis für mögliche doppelte Personen automatisieren](getting-started/quick-wins/advanced-solutions/automate-an-alert-for-possible-duplicate-people.md)
...
+ Produktdokumentationen {#product-docs}
   ...
   + Zusätzliche Apps {#additional-apps}
      + SEO {#seo}
         + Grundlagen zu SEO {#understanding-seo}
   ...
   + Administration {#administration}
      ...
      + Zusätzliche Integrationen {#additional-integrations}
         ...
         + [Google AdWords als LaunchPoint-Dienst hinzufügen](product-docs/administration/additional-integrations/add-google-adwords-as-a-launchpoint-service.md)
         ...
         + [Hinzufügen von Slack als LaunchPoint-Dienst](product-docs/administration/additional-integrations/add-slack-as-a-launchpoint-service.md)
      ...
      + Arbeitsbereiche und Personen-Partitionen {#workspaces-and-person-partitions}
         ...
         + [Zuweisen von Personenpartitionen zu Zuordnungsregeln](product-docs/administration/workspaces-and-person-partitions/assigning-person-partitions-with-assignment-rules.md)
         ...
         + [Neuen Arbeitsbereich erstellen](product-docs/administration/workspaces-and-person-partitions/create-a-new-workspace.md)
   ...
   + Kernkonzepte von Marketo {#core-marketo-concepts}
      + Intelligente Kampagnen {#smart-campaigns}
         ...
         + Microsoft Dynamics Flow Actions {#microsoft-dynamics-flow-actions}
            ...
            + [Aufgabe erstellen in Microsoft](product-docs/core-marketo-concepts/smart-campaigns/microsoft-dynamics-flow-actions/create-task-in-microsoft.md)
         ...
         + Daten intelligenter Kampagnen {#smart-campaign-data}
      ...
      + Smart-Listen und statische Listen {#smart-lists-and-static-lists}
         ...
         + Statische Listen {#static-lists}
            ...
            + [Adobe Experience Cloud-Segment in eine statische Marketo-Liste pushen](product-docs/core-marketo-concepts/smart-lists-and-static-lists/static-lists/push-an-adobe-experience-cloud-segment-to-a-marketo-static-list.md)
      ...
      + Marketingkalender {#marketing-calendar}
         ...
         + Arbeiten mit dem Kalender {#working-with-the-calendar}
            ...
            + [Filtern des Marketing-Kalenders nach Arbeitsbereich](product-docs/core-marketo-concepts/marketing-calendar/working-with-the-calendar/filtering-the-marketing-calendar-by-workspace.md)
      ...
      + Mobile Apps {#mobile-apps}
         + Ereigniseinchecken {#event-check-in}
            ...
            + [iPad oder Android-Tablet einrichten](product-docs/core-marketo-concepts/mobile-apps/event-check-in/set-up-the-ipad-or-android-tablet.md)
         + Marketo Moments {#marketo-moments}
            + Grundlagen zu Momenten {#understanding-moments}
   ...
   + CRM-Synch.{#crm-sync}
      + Microsoft Dynamics Sync {#microsoft-dynamics}
         ...
         + Sync Setup {#sync-setup}
            ...
            + Microsoft Dynamics 2011 On-Premises {#microsoft-dynamics-2011-on-premises}
               + [Schritt 1 von 3: Installieren Sie die Marketo-Lösung (On-Premises 2011)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2011-on-premises/step-1-of-3-install.md)
            ...
            + Microsoft Dynamics 2013 On-Premises {#microsoft-dynamics-2013-on-premises}
               + [Schritt 1 von 3: Installieren der Marketo-Lösung in Dynamics (On-Premises 2013)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2013-on-premises/step-1-of-3-install.md)
               + [Schritt 2 von 3: Konfigurieren der Synchronisierungsbenutzer für Marketo (On-Premises 2013)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2013-on-premises/step-2-of-3-configure.md)
               + [Schritt 3 von 3: Marketo und Dynamics verbinden (On-Premises 2013)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2013-on-premises/step-3-of-3-connect.md)
            + Microsoft Dynamics 2015 On-Premises/2016 Dynamics 365 On-Premises {#microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises}
               ...
               + [Schritt 2 von 3: Einrichten eines Marketo-Synchronisierungsbenutzers in Dynamics 2015 On-Premises/2016 Dynamics 365 On-Premises](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises/step-2-of-3-set-up.md)
               + [Schritt 3 von 3: Marketo und Dynamics 2015 On-Premises/2016 Dynamics 365 On-Premises verbinden](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises/step-3-of-3-connect.md)
            + Microsoft Dynamics 365 {#microsoft-dynamics-365}
               + [Schritt 1 von 3: Installieren der Marketo-Lösung (Online)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365/step-1-of-3-install.md)
               + [Schritt 2 von 3: Einrichten des Marketo Sync User in Dynamics](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365/step-2-of-3-set-up.md)
            ...
            + Einrichten der OAuth-Authentifizierung für Dynamics {#set-up-oauth-authentication-for-dynamics}
               + [Erteilen der Zustimmung für die Kunden-ID und App-Registrierung](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/set-up-oauth-authentication-for-dynamics/grant-consent-for-client-id-and-app-registration.md)
               ...
               + [Einrichten der Microsoft Dynamics CRM-App für On-Premise](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/set-up-oauth-authentication-for-dynamics/set-up-microsoft-dynamics-crm-app-for-on-prem.md)
               + [Einrichten von MSD für Azure AD Federated mit AD FS On-Premise, Mandant und Microsoft Online](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/set-up-oauth-authentication-for-dynamics/set-up-msd-for-azure-ad-federated-with-ad-fs-on-prem-tenant-and-microsoft-online.md)
      ...
      + Einrichten {#setup}
         ...
         + Details zur SFDC-Synchronisierung {#sfdc-sync-details}
            ...
            + [Verwenden von Personenkonten](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-account-sync/using-person-accounts.md)
   ...
   + Nachfragesteigerung {#demand-generation}
      ...
      + Veranstaltungen {#events}
         + Verstehen von Ereignissen {#understanding-events}
            ...
            + [LaunchPoint-Ereignispartner](product-docs/demand-generation/events/understanding-events/launchpoint-event-partners.md)
         ...
         + Erstellen eines Ereignisses {#create-an-event}
            ...
            + Erstellen Sie ein Ereignis mit dem Marketo ON24-Adapter {#create-an-event-with-the-marketo-on24-adapter}
               ...
               + [Anmeldedaten für ON24 in Marketo eingeben](product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/enter-your-on24-credentials-in-marketo.md)
      ...
      + Formulare {#forms}
         ...
         + Formularfelder {#form-fields}
            ...
            + [Vorab-Ausfüllen für ein Formularfeld deaktivieren](product-docs/demand-generation/forms/form-fields/disable-pre-fill-for-a-form-field.md)
      ...
      + Bilder und Dateien {#images-and-files}
         ...
         + [Ersetzen eines hochgeladenen Bildes oder einer hochgeladenen Datei](product-docs/demand-generation/images-and-files/replace-an-uploaded-image-or-file.md)
      ...
      + Landing Pages {#landing-pages}
         ...
         + Freiform-Einstiegsseiten {#free-form-landing-pages}
            ...
            + [Hinzufügen von benutzerdefiniertem HTML zu einer Freiform-Einstiegsseite](product-docs/demand-generation/landing-pages/free-form-landing-pages/adding-custom-html-to-a-free-form-landing-page.md)
         ...
         + Landing Page-Vorlagen {#landing-page-templates}
            ...
            + Geführte Landingpage-Vorlagen {#guided-landing-page-templates}
               ...
               + [Vorlage 10-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10-a.md)
               + [Vorlage 10-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10-b.md)
               ...
               + [Vorlage 11-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11-a.md)
               ...
               + [Vorlage 12-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12-a.md)
               ...
               + [Vorlage 13-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13-a.md)
               ...
               + [Vorlage 13-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13-c.md)
               ...
               + [Vorlage 13-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13-e.md)
               + [Vorlage 14-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-14-a.md)
               ...
               + [Vorlage 14-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-14-e.md)
               + [Vorlage 15-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-15-a.md)
               ...
               + [Vorlage 16-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16-a.md)
               + [Vorlage 16-B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16-b.md)
               ...
               + [Vorlage 16-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16-e.md)
               + [Vorlage 17-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17-a.md)
               ...
               + [Vorlage 17-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17-e.md)
               + [Vorlage 18-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-18-a.md)
               ...
               + [Vorlage 18-E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-18-e.md)
               + [Vorlage 19-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19-a.md)
               ...
               + [Vorlage 20-A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-20-a.md)
      ...
      + Sozial {#social}
         + Konfigurieren von Social-Aktionen {#configuring-social-actions}
            ...
            + [Social-Anmelde-/Freigabefluss konfigurieren](product-docs/demand-generation/social/configuring-social-actions/configure-social-sign-up-share-flow.md)
            ...
            + [Einrichten der Umsatzzuordnung für digitale Werbekampagnen](product-docs/demand-generation/social/configuring-social-actions/set-up-revenue-attribution-for-digital-advertising-campaigns.md)
         ...
         + Empfehlungsangebote {#referral-offers}
            ...
            + [Veröffentlichen eines Verweisangebots](product-docs/demand-generation/social/referral-offers/publish-a-referral-offer.md)
         ...
         + Gewinnspiele {#sweepstakes}
            ...
            + [Preisausschreiben für Gewinner auswählen](product-docs/demand-generation/social/sweepstakes/select-sweepstakes-winners.md)
   ...
   + Marketo Engage-Erlebnis der nächsten Generation {#marketo-engage-next-generation-experience}
   ...
   + Marketo Sales Connect {#marketo-sales-connect}
      ...
      + Administrator {#admin}
         ...
         + [Registerkarte &quot;Admin Settings&quot;](product-docs/marketo-sales-connect/admin/admin-settings-tab.md)
      ...
      + E-Mail-Plugins {#email-plugins}
         + Gmail {#gmail}
            ...
            + [Installieren der ToutApp-Browsererweiterung](product-docs/marketo-sales-connect/email-plugins/gmail/how-to-install-the-toutapp-browser-extension.md)
      ...
      + E-Mail {#email}
         ...
         + Häufige Tracking-Fragen {#common-tracking-questions}
            + [Funktionsweise des Antworten-Trackings](product-docs/marketo-sales-connect/email/common-tracking-questions/how-reply-tracking-works.md)
            ...
            + [Vermeidung von Selbstansichten](product-docs/marketo-sales-connect/email/common-tracking-questions/preventing-self-views.md)
         ...
         + E-Mail zum Vertrieb senden {#send-a-sales-email}
            ...
            + [E-Mail zu Salesforce hinzufügen von Gmail](product-docs/marketo-sales-connect/email/send-a-sales-email/add-email-to-salesforce-from-gmail.md)
            + [E-Mail zu Salesforce hinzufügen in E-Mail-Client](product-docs/marketo-sales-connect/email/send-a-sales-email/add-email-to-salesforce-in-email-client.md)
            ...
            + [E-Mail ausgewählt und E-Mail-Gruppe](product-docs/marketo-sales-connect/email/send-a-sales-email/email-selected-and-email-group.md)
            + [E-Mails an Spam](product-docs/marketo-sales-connect/email/send-a-sales-email/emails-going-to-spam.md)
            + [Fehler beim Senden aus Gmail oder Outlook](product-docs/marketo-sales-connect/email/send-a-sales-email/error-when-sending-from-gmail-or-outlook.md)
            + [Fehler beim Senden über die Webanwendung](product-docs/marketo-sales-connect/email/send-a-sales-email/error-when-sending-from-the-web-application.md)
            ...
            + [Senden einer Gruppen-E-Mail](product-docs/marketo-sales-connect/email/send-a-sales-email/how-to-send-a-group-email.md)
            + [So senden Sie eine E-Mail aus einer Vertriebsaktion](product-docs/marketo-sales-connect/email/send-a-sales-email/how-to-send-an-email-from-sales-engage.md)
            + [Geplante E-Mails werden in Entwürfe verschoben](product-docs/marketo-sales-connect/email/send-a-sales-email/scheduled-emails-going-to-drafts.md)
            ...
            + [Einschränken der Fehlermeldung bei fehlgeschlagenem Versand](product-docs/marketo-sales-connect/email/send-a-sales-email/throttling-error-message-in-a-failed-delivery.md)
            + [Einschränkungsfehler](product-docs/marketo-sales-connect/email/send-a-sales-email/throttling-errors.md)
         + Der Live-Feed {#the-live-feed}
            ...
            + [Live-Feed-Symbol - Glossar](product-docs/marketo-sales-connect/email/the-live-feed/live-feed-icon-glossary.md)
         ...
         + Abbestellungen {#unsubscribes}
            ...
            + [Abmeldung](product-docs/marketo-sales-connect/email/unsubscribes/resubscribing-an-unsubscribe.md)
      ...
      + Personal {#people}
         ...
         + Verwalten von Kontakten {#managing-contacts}
            ...
            + [Verbinden Ihrer Marketo-Leads mit Sales Connect-Leads](product-docs/marketo-sales-connect/people/managing-contacts/connect-your-marketo-leads-with-sales-connect-leads.md)
            ...
            + [Formatieren automatischer Abmeldungen](product-docs/marketo-sales-connect/people/managing-contacts/how-to-format-auto-unsubscribes.md)
            ...
            + [Zusammenführen von zwei Gruppen](product-docs/marketo-sales-connect/people/managing-contacts/how-to-merge-two-groups-together.md)
      ...
      + Vorlagen {#templates}
         + [Anlage hinzufügen](product-docs/marketo-sales-connect/templates/add-an-attachment.md)
         + [Bild hinzufügen](product-docs/marketo-sales-connect/templates/add-an-image.md)
         ...
         + [Hinzufügen von Videoinhalten](product-docs/marketo-sales-connect/templates/add-video-content.md)
         ...
         + [Erstellen einer Folgenachvorlage](product-docs/marketo-sales-connect/templates/create-a-follow-up-template.md)
         ...
         + [Kategoriefreigabe aktivieren](product-docs/marketo-sales-connect/templates/enable-category-sharing.md)
   ...
   + Marketo Sales Insight {#marketo-sales-insight}
      ...
      + MSI für Microsoft Dynamics {#msi-for-microsoft-dynamics}
         ...
         + Einrichten und Verwenden von {#setting-up-and-using}
            + [Lead/Kontakt zu einer Marketo-Kampagne aus Microsoft Dynamics hinzufügen](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/setting-up-and-using/add-a-lead-contact-to-a-marketo-campaign-from-microsoft-dynamics.md)
            ...
            + [Marketo Sales Email von Microsoft Dynamics senden](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/setting-up-and-using/send-a-marketo-sales-email-from-microsoft-dynamics.md)
      ...
      + MSI für Salesforce {#msi-for-salesforce}
         ...
         + Funktionen {#features}
            ...
            + Aktionen im MSI-Bedienfeld {#actions-in-the-msi-panel}
               + [Hinzufügen eines Leads/Kontakts zu einer Marketo-Kampagne von Salesforce](product-docs/marketo-sales-insight/msi-for-salesforce/features/actions-in-the-msi-panel/add-to-marketo-campaign/add-a-lead-contact-to-a-marketo-campaign-from-salesforce.md)
            ...
            + Massenaktionen {#bulk-actions}
               + [Hinzufügen der Registerkarte &quot;Marketo Sales Insight&quot;und der Schaltflächen zu Salesforce](product-docs/marketo-sales-insight/msi-for-salesforce/features/bulk-actions/add-marketo-sales-insight-tab-and-buttons-to-salesforce.md)
   ...
   + Mobiles Marketing {#mobile-marketing}
      + Administrator {#admin}
         ...
         + [Konfigurieren des iOS-Push-Zugriffs für die mobile App](product-docs/mobile-marketing/admin/configure-mobile-app-ios-push-access.md)
   ...
   + Prädiktive Inhalte {#predictive-content}
      ...
      + Arbeiten mit Predictive Content {#working-with-predictive-content}
         + [Grundlegendes zu vorausschauenden Inhalten](product-docs/predictive-content/working-with-predictive-content/understanding-predictive-content.md)
   ...
   + Berichterstellung {#reporting}
      ...
      + Revenue Cycle Analytics {#revenue-cycle-analytics}
         ...
         + Umsatzzyklusmodelle {#revenue-cycle-models}
            ...
            + [Zusammenführen von zwei Phasen im Umsatzmodellen](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/merging-two-stages-in-the-revenue-modeler.md)
            ...
            + [Start des Trackings nach Konto im Umsatzmodell](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/start-tracking-by-account-in-the-revenue-modeler.md)
   ...
   + Webpersonalisierung {#web-personalization}
      ...
      + Erste Schritte {#getting-started}
         ...
         + [Einstellen der Web-Personalisierung auf &quot;Nicht verfolgen&quot;](product-docs/web-personalization/getting-started/setting-web-personalization-to-do-not-track.md)
      ...
      + RTP Tag Implementation {#rtp-tag-implementation}
         ...
         + [Implementieren von RTP mit Google Tag Manager](product-docs/web-personalization/rtp-tag-implementation/implementing-rtp-using-google-tag-manager.md)
      ...
      + Grundlagen zur Web-Personalisierung {#understanding-web-personalization}
         ...
         + [Glossar zur Web-Personalisierung](product-docs/web-personalization/understanding-web-personalization/web-personalization-glossary.md)
      ...
      + Websegmente verwenden {#using-web-segments}
         ...
         + [Anzeigen von Segmenten aus einer bestimmten Bezeichnung](product-docs/web-personalization/using-web-segments/view-segments-from-a-specific-label.md)
      ...
      + Arbeiten mit Web-Kampagnen {#working-with-web-campaigns}
         ...
         + [Definieren einer intelligenten Liste für Web-Personalisierungsaktivitäten](product-docs/web-personalization/working-with-web-campaigns/define-a-smart-list-for-web-personalization-activities.md)
...
+ Versionshinweise {#release-notes}
   ...
   + 2021 {#2021}
      + [Versionshinweise: Jan. 21](release-notes/2021/release-notes-jan-21.md)
      + [Versionshinweise: Mai 21](release-notes/2021/release-notes-may-21.md)
   + 2020 {#2020}
      + [Versionshinweise: Januar 20](release-notes/2020/release-notes-jan-20.md)
      + [Versionshinweise: Februar 2020](release-notes/2020/release-notes-feb-20.md)
   ...
   + 2019 {#2019}
      + [Versionshinweise: August &#39;19](release-notes/2019/release-notes-august-19.md)
   ...
   + 2017 {#2017}
      + [Versionshinweise: ABM-Verbesserungen vom April 17](release-notes/2017/release-notes-april-17-abm-enhancements.md)
