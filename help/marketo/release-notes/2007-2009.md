...
* **Trigger und Filter** der Gelegenheit: Verbesserte Bearbeitung von Möglichkeiten einschließlich komplexer Suchkriterien.
...
* **Lesezeichen**: Geben Sie Ihre Lieblingsseiten mit Ihren Freunden frei!
...
* **Salesforce-Link in Informationen** zur Versandwarnung: Wenn Sie in einer E-Mail ein Token für die Benachrichtigung über Senden verwenden und der Interessent in Salesforce ist, erhalten Sie Links zu Salesforce und Marketo.
* **Benutzerdefinierte Felder** für Salesforce-Konto: Ihre benutzerdefinierten Salesforce-Kontofelder stehen jetzt in Marketo zur Verfügung.
...
* **Enhanced ****Geo-location**: Wir erfassen jetzt zusätzliche Daten, die Ihnen helfen, Ihre Interessenten zu identifizieren, einschließlich Stadt, Bundesland/Region, Postleitzahl, Telefongebietscode und Metrobereich.
...
* **Outlook-Plugin**: Erlauben Sie Ihren Mitarbeitern, E-Mails von Outlook zu senden und das Senden/Klicken/Öffnen in Marketo zu verfolgen. Sogar Trigger der Aktivität!
...
* **Salesforce-Kampagnen**: Sie können jetzt die Salesforce-Kampagnen filtern und Trigger ablegen sowie Interessenten anhand beliebiger Kriterien in Kampagnen setzen. Verwenden Sie es einfach wie einen normalen Flussschritt.
* **Anonyme Interessenten - Filter und Trigger**: Dies sind äußerst leistungsstarke neue Filter und Trigger, die Ihnen einen beispiellosen Einblick in anonyme Besucher auf Ihrer Site verschaffen. Jetzt können Sie sogar sagen, wenn ein Konkurrent schweigend Intelligenz auf Ihrer Website sammelt!
...
* **Nach der gängigen Anfrage haben wir neue E-Mail-Spalten im Abschnitt** Analyse hinzugefügt: Das E-Mail-Diagramm zeigt jetzt detailliertere Informationen an, einschließlich der Anzahl der gesendeten, abgespielten, Versand- und Abmeldung. Auf der Registerkarte &quot;Kampagne **Zusammenfassung&quot;wird die E-Mail-Leistungszusammenfassung** nicht mehr angezeigt: Zur Ansicht dieser Informationen gibt es jetzt eine Registerkarte für E-Mails. Dieser Bericht steht auch pro Kampagne zur Verfügung.

* **Zugeordnete Interessenten-API-Funktion**: Dies ist eine neue Funktion in der JavaScript-Datei Munchkin, mit der Sie ein Drittanbietersystem und Ihr Marketo-Konto integrieren können.
...
* **Schritt** zum Senden des Warnhinweises: Dies ist ein großer neuer Flussschritt, der es Ihnen ermöglicht, Verkäufer oder andere Interessenträger zu warnen, wenn bestimmte Kampagnen ausgeführt werden. Verwenden Sie sie wie alle anderen Flussschritte, um die Funktion zum Senden von Warnhinweisen Trigger.
...
* **Push-Aktivitäten von Marketo nach Salesforce**: Klicken Sie einfach auf admin->Salesforce und überprüfen Sie die Aktivitäten, die Sie mit Ihrem Vertriebsteam teilen möchten.
...
* **Exportieren Sie aus einer** beliebigen Liste, einer intelligenten Liste und sogar aus der Aktivität, um eine Kampagne zu erhalten. Schauen Sie sich einfach das untere Raster an und klicken Sie auf Export.
...
* **Schnelle** Verbesserungen am munchkin-Skript und mehrere Kategorien intelligenter Listen und Suchen.
* **Drag &amp;** Dronow funktioniert auch, wenn Sie das Symbol erfassen. Ich weiß, das war nervig. Alles fest!
...
* Blei-DB &quot;**Schnellsuche**&quot;durchsucht nun den Namen, den Titel, die Firma und die E-Mail-Adresse. Funktioniert auch mit Paginierung.
...
* **Löschen und** Umbenennen von Ordnern, Programmen in der Struktur.
...
* **Erweiterungen** der Benutzeroberfläche für die Spaltenauswahl: Wählen Sie Spalten für ein Raster aus, indem Sie auf den Trigger in der Kopfzeile klicken.
