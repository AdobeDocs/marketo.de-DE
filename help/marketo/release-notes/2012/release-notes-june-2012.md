...
## Landingpages-Rasterlinien {#landing-page-gridlines}
...
## Aus Postings blockierte Interessenten {#leads-blocked-from-mailings}
...
## Verbesserungen von Marketing-zu-Umsatz-Cycle-Analysen {#marketo-revenue-cycle-analytics-enhancements}

### Neue Metriken in der Analyse zu Programm-Chancen  {#new-metrics-in-program-opportunity-analysis}
...
## Diagrammtyp für Heat-Raster  {#heat-grid-chart-type}
