...
* **Data.com-Integration**: Erweitern Sie Ihre Daten mit Data.com mithilfe einer neuen Marketo-Flussaktion.
...
* **Programm Performance-Filter**: Filtern Sie den Programm-Leistungsbericht nach Tags und Kanälen, um Ihre Marketo-Programm für den Berichte zu gruppieren und zu vergleichen.
...
* **WebEx-Adapter**: Schließen Sie nahtlos ein Smart-Ereignis an ein WebEx-Ereignis an (WebEx-Ereignis-Center erforderlich) und verwenden Sie Marketo-Landingpages und -Formulare, um Registrierungspflichtige zu erfassen und sie automatisch in WebEx zu registrieren.
...
* **WebEx-Adapter**: Push registration information to WebEx via Marketo Kampagnen und Pull Anwesenheitsinformationen nach Ereignis.
...
* **Erfolgspfadanalyse**: Überprüfen Sie bei Umsatz-Cycle Explorer-Kunden die Modellleistung von Marketo Lead Management aus.
...
* **Manuelle Änderung** der Modellphase: Verwenden Sie diesen Trigger in Ihrem Modell, wenn Interessenten manuell in eine Phase verschoben werden.
...
* **ICS-Datei-Uploads**: Browser behandeln ICS-Dateidownloads von Marketo ordnungsgemäß.
