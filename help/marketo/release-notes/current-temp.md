 ...
 <tbody> 
  <tr> 
   ...
   <td> </td>
    ...
    <tr> 
   <td><strong>Konversionsflusslogik neu anordnen</strong>: Sie können jetzt die Logik neu anordnen, in der die Bedingungslogik für Konversionsflüsse konfiguriert ist, anstatt sie löschen und lesen zu müssen.</td> 
   <td><i>Demnächst verfügbar</i></td>
   <td><i>Demnächst verfügbar</i></td>
   </tr>
 </tbody> 
...
* **Einstellung des Kontoinsight-Browser-Plug-ins**: Adobe entfernt die [Account Insight-Browser-Plugin](/help/marketo/product-docs/target-account-management/setup-tam/account-insight-plug-in-overview.md) vom Chrome Web Store am 18. März 2024. Vorhandene Benutzer: Sie können das Plug-in weiter verwenden, bis Sie Ihre Marketo Engage-Instanz zu Adobe Identity und Admin Console migrieren.
