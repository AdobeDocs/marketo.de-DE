...
Die folgenden Funktionen fallen unter den Standard-Versionszyklus und werden ab der Veröffentlichung auf **19. Mai 2023**, mit einer stufenweisen Einführung der verbleibenden Funktionen in den darauffolgenden Wochen. Die Veröffentlichungsfunktionen und -daten können sich ändern. Bitte prüfen Sie unten jedes Feature nach seinem Status.
...
* **Interaktive Webinare - Ankündigung neuer Funktionen und zugehörige Funktionen (begrenzte Verfügbarkeit im Mai)**:

Interaktive Webinare sind die neueste Funktion von Adobe Marketo Engage, die das bestehende Events- und Webinarerlebnis erweitert, indem sie Marketingfachleuten ein natives und nahtloses Erlebnis bieten, mit dem sie Ereignisse in Marketo Engage erstellen, verwalten und bereitstellen können. Marketingexperten können ein Webinar nach Ereignistyp anpassen, Präsenzkräfte hinzufügen, umfassende Einblicke in Interaktionen über Adobe Connect-Funktionen wie Live-Umfragen, Chat, Fragen und Antworten, Web-Link-Klicks, Dokumentdownloads usw. erhalten, die Aufzeichnung des Webinars direkt in Marketo Engage abrufen, die Webinarleistung über Rich-Dashboard bewerten und vieles mehr.
