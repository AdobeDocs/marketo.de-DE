...
# Versionshinweise – März 2026 {#release-notes-mar-26}
...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   <td><strong>Push-Benachrichtigungen</strong>: Umleitungs-URLs, die in Push-Benachrichtigungen konfiguriert sind, unterstützen jetzt Marketo Engage-Token (nur für <i>Launch-App-</i>).
   </td>
   <td><i>Demnächst verfügbar</i></td>
   <td><i>Demnächst verfügbar</i></td>
  </tr>
