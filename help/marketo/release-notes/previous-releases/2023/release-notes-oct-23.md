...
# Versionshinweise: Oktober 2023 {#release-notes-oct-23}

Im Folgenden finden Sie alle Funktionen, die in der Version vom Oktober 2023 enthalten sind. Überprüfen Sie Ihre Adobe Marketo Engage Edition auf die Verfügbarkeit der Funktionen.
...
<table style="table-layout:auto"> 
 <tbody> 
  ...
  <tr> 
   ...
   <tr> 
   <td><strong>Formel-Fluss-Schritt-Service berechnen</strong>: Formel berechnen ist ein Fluss-Schritt-Service, der auf der IO-Laufzeitplattform von Adobe für die Verwendung mit Marketo Engage-Smart-Kampagnen basiert. Benutzer mit IO-Laufzeitumgebung können den Dienst bereitstellen und auf ihren Marketo Engage-Abonnements installieren, sodass sie Excel-ähnliche Formeln in Marketo Engage-Smart-Kampagnen berechnen können.</td> 
   <td>Versendet</td>
...
* **Einstellung von Marketo Events und Marketo Moments**: Adobe wird [Entfernen von Marketo Events und Marketo ](https://nation.marketo.com/t5/product-discussions/marketo-events-app-and-marketo-moments-app-end-of-life/m-p/340712/highlight/true#M193869){target="_blank"}) ab dem 2. Oktober 2023 aus allen App-Stores entfernt. Vorhandene Benutzende: Sie können diese Apps weiterhin verwenden, bis Sie Ihre Marketo Engage-Instanz zu Adobe Identity migrieren. Diese Apps unterstützen nicht die Anmeldung bei Adobe ID.
