...
## Marketo-Leistungseinblicke {#marketo-performance-insights}

[Marketo-Leistungseinblicke](/help/marketo/product-docs/reporting/performance-insights/performance-insights-overview.md)
...
Wir haben ein Aktualisierungstoken in unseren Lösungen für Retargeting und [!UICONTROL LinkedIn-Lead-Gen] implementiert, das die Zugriffszeit auf ein Jahr verlängert, bevor eine erneute Authentifizierung erforderlich wird.
