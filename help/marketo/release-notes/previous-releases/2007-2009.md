...
* **Benutzerdefinierte Smart-Listen-Spalten**: Fügen Sie Ihren Berichten basierend auf intelligenten Listen neue Daten hinzu.
...
* **Trigger und Filter für Opportunity**: Verbesserte Handhabung von Opportunitäten einschließlich komplexer Suchkriterien.
...
* **Suchen nach Bildern und Dateien**: Schnelles Auffinden der hochgeladenen Assets
...
* **Verbesserte Leistung zusammen mit Änderungen an der Benutzeroberfläche**: Die Website ist jetzt schneller als je zuvor, insbesondere für IE7-Benutzer.
* **Salesforce-Link in Informationen zu Warnhinweisen senden**: Wenn Sie ein Warnhinweis-Info-Token in einer E-Mail verwenden und sich der Lead in Salesforce befindet, erhalten Sie Links zu Salesforce und Marketo.
* **Benutzerdefinierte Felder für Salesforce-Konten**: Ihre benutzerdefinierten Salesforce-Kontofelder stehen jetzt zur Verwendung in Marketo zur Verfügung.
...
* **Verbessert ****Geostandort**: Wir erfassen jetzt zusätzliche abgeleitete Daten, die Ihnen dabei helfen, Ihre Leads zu identifizieren, einschließlich untergeordneter Stadt, Bundesland/Region, Postleitzahl, Telefongebietscode und U-Bahn-Bereich.
...
* **Anonyme Lead-Filter und -Trigger**: Dies sind extrem leistungsstarke neue Filter und Trigger, die Ihnen einen noch nie da gewesenen Einblick in anonyme Besucher auf Ihrer Site verschaffen. Jetzt können Sie sogar feststellen, wann ein Konkurrent schweigend Intelligenz auf Ihrer Website sammeln wird!
* **Wechsel zu einer größeren Hosting-Umgebung**: Das war eine Herkulesaufgabe, aber wir haben es ohne Chaos geschafft! Wir haben das gesamte Unternehmen auf einen viel skalierbareren Hosting-Dienst umgestellt. Wir verfügen jetzt über mehrere geclusterte Pods mit Skalierbarkeit, um diese zu sparen.
...
* **Schnellsuchfeld**: Das Explorer Tree Filtering Control wurde durch ein Suchfeld &quot;Schnellsuche&quot;ersetzt. Mit diesem Suchfeld &quot;Schnellsuche&quot;können Sie Ihre Assets durchsuchen.
...
* **Nach beliebter Anfrage haben wir neue E-Mail-Spalten im Analysebereich hinzugefügt**: Das E-Mail-Diagramm zeigt jetzt detailliertere Informationen, einschließlich der Anzahl der gesendeten, Bounce-, Versand- und Abmeldungen. Die Kampagne **Auf der Registerkarte &quot;Zusammenfassung&quot;wird die E-Mail-Leistungszusammenfassung nicht mehr angezeigt.**: Um diese Informationen anzuzeigen, gibt es jetzt einen Tab E-Mail . Dieser Bericht ist auch pro Kampagne verfügbar.
...
* **Schritt &quot;Warnfluss senden&quot;**: Dies ist ein großartiger neuer Flussschritt, mit dem Sie Verkäufer oder andere Interessengruppen auf die Ausführung bestimmter Kampagnen aufmerksam machen können. Verwenden Sie sie wie jeden anderen Flussschritt, um die Funktion zum Senden von Warnhinweisen Trigger.
...
* **Berichtsverbesserungen**: Jetzt können Sie beliebig viele Berichte erstellen und diese in Ordnern organisieren. Verwenden Sie Smart-Listen , um die Bedeutung der Berichte zu ändern.
* **Neue Spalten für Opportunity-Daten (Opty)**: Dadurch werden wichtige Fragen zur Wirksamkeit der Marketingaktivitäten beantwortet.
* **Verbesserungen bei Leaddetails**: Die Seite mit den Lead-Details wurde auch für die Benutzerfreundlichkeit verbessert und um in Salesforce neue Details zu Opportunity hinzuzufügen. Sehen Sie sich die neuen Lead-Details an und teilen Sie uns Ihre Meinung mit.
...
* **Verbesserte Entwürfe von Einstiegsseiten in Design Studio**: Wenn Sie nun einen Entwurf erstellen, wird in der Ordnerstruktur ein separates Entwurfssymbol angezeigt. Diese Verbesserung der Benutzerfreundlichkeit soll dazu beitragen, E-Mails und Landingpages klarer zu gestalten.
* **Mehr Leistung bei intelligenten Listenfiltern**: Sie können jetzt negative Vorgänge verwenden. Sie können beispielsweise alle Personen finden, die NICHT auf einen bestimmten Link geklickt haben.
...
* **Exportieren von** Liste, intelligente Liste und sogar die Aktivitätsergebnisse einer Kampagne. Schauen Sie sich einfach den unteren Rand des Rasters an und klicken Sie auf &quot;Exportieren&quot;.
...
* **Verbesserte Serverproduktion um 300 %** mit Clustering und Hardware-Upgrades für Unternehmen. Wir sind für hervorragende Betriebszeit und Serverleistung. Auch hier kommen noch mehr Überraschungen auf uns zu.
* **Verbesserte Leistung bei der Verwendung von ANY-Auswahlmöglichkeiten in einer intelligenten Liste**: Früher war es viel langsamer, aber jetzt ist es komisch!
...
* **Aktionen &quot;Zu Liste hinzufügen und aus Liste entfernen&quot;**: Viele Möglichkeiten zur Verwendung dieser statischen Listen. Probiere sie aus.
...
* **Bearbeiten des standardmäßigen Abmelde-Textes**: Klicken Sie auf &quot;admin&quot;, dann auf &quot;email&quot;, und Sie können den Text zum Abmelden bearbeiten, der unten in E-Mails gedruckt wird. HTML und Textversionen für mehrteilige E-Mails.
* **Abonnement-Zeitzone festlegen**: Dies wird ab sofort in der App verwendet. Klicken Sie auf Admin, melden Sie sich an und bearbeiten Sie die Zeitzone für Ihr Abonnement.
* **Filteransicht in Smart-Listen in Campaign**: Sehen Sie sich die Smart-Listen der Kampagne in der Lead-Datenbank an. Jetzt zeigen sie die historische Mitgliedschaft, die Smart-List-Definition und eine aktuelle Momentaufnahme der entsprechenden Leads in der Datenbank (Filteransicht).
...
* **Drag &amp; Drop** funktioniert jetzt auch, wenn Sie das Symbol abrufen. Ich weiß, das war nervig. Alles repariert!
...
* Lead DB &quot;**Schnellsuche**&quot; sucht nun Name, Titel, Unternehmen und E-Mail-Adresse. Funktioniert auch mit Paginierung.
...
* **Drag &amp; Drop**: Versuchen Sie, eine Kampagne von einem Programm auf ein anderes zu ziehen!
...
* **Wesentliche Leistungsoptimierungen** überall hin.
...
* Oodles **Fehlerbehebungen**.

## Dezember 2007 {#december-1}

* **Enorme Verbesserungen der Geschwindigkeit der Lead-Datenbank**: Das Klicken auf die meisten Smart-Listen und -Listen dauert jetzt einige Sekunden statt Minuten.
...
* **Einstellungen für fixierbare Spalten**: Bei jeder Sortierung oder Neuanordnung von Spalten speichert Marketo diese Voreinstellungen.
...
* **Suchfeld für E-Mail-ersetzenden Text**: Dieses Feld können Sie im E-Mail-Editor einfach finden.
