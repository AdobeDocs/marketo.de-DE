...
* **Benutzerdefinierte Objekte [!DNL Salesforce]**: Verwenden Sie Ihre [!DNL Salesforce] in Smart-Listen und Kampagnen.
...
* **Ursprüngliche Quellinformationen in[!DNL Salesforce]**: Aktualisieren Sie Ihre Marketo AppExchange-App auf neue Felder.
...
* **[!DNL Salesforce]Link in „Warnhinweisinfo senden**: Wenn Sie ein Token zum Senden von Warnhinweisinformationen in einer E-Mail verwenden und der Lead sich in [!DNL Salesforce] befindet, erhalten Sie Links zu [!DNL Salesforce] und Marketo.
* Benutzerdefinierte **[!DNL Salesforce]-**: Ihre benutzerdefinierten [!DNL Salesforce]-Kontofelder können jetzt in Marketo verwendet werden.
...
* **Enhanced**&#x200B;**Geo-location**: Wir sammeln jetzt zusätzliche abgeleitete Daten, um Ihnen zu helfen, Ihre Leads zu identifizieren, einschließlich abgeleiteter Stadt, Bundesland/Region, Postleitzahl, Telefonvorwahl und Metropolbereich.
...
* **[!DNL Outlook]-Plug**: Erlauben Sie Ihren Mitarbeitern, E-Mails von [!DNL Outlook] zu senden und die gesendeten/geklickten/geöffneten in Marketo zu verfolgen. Sogar Trigger von Aktivität!
...
* **[!DNL Salesforce]Kampagnen**: Sie können jetzt [!DNL Salesforce] Kampagnen filtern und aus ihnen Trigger erstellen sowie Leads basierend auf beliebigen Kriterien in Kampagnen einfügen. Verwenden Sie sie einfach wie einen regulären Flussschritt.
* **Anonyme Lead-Filter und -Trigger**: Hierbei handelt es sich um extrem leistungsstarke neue Filter und Trigger, mit denen Sie beispiellose insight-Inhalte für anonyme Besucher auf Ihrer Site erstellen können. Jetzt können Sie sogar erkennen, wenn ein Konkurrent stumm auf Ihrer Website Informationen sammelt!
...
* **Lead-Detail**: Mein Layout. Wissen Sie, wie das Popup-Fenster mit Lead-Details viele Felder enthält? Nun, wir haben gehört, dass man ein Dashboard-Layout auf die Startseite setzen muss und sich aussuchen kann, welche Felder dorthin gehen. Klicken Sie einfach oben rechts auf Admin und dann auf Lead-Detail-Layout. Alles per Drag-and-Drop, sodass es einfach zu erstellen sein sollte.
...
* **Lead-Detail-**: Die Seite „Lead-Detail“ wurde ebenfalls verbessert, um die Benutzerfreundlichkeit zu verbessern und neue Opportunity-Details aus [!DNL Salesforce] hinzuzufügen. Sehen Sie sich die neuen Lead-Details an und teilen Sie uns Ihre Meinung mit.
...
* **Push-Aktivitäten von Marketo nach[!DNL Salesforce]**: Klicken Sie einfach auf „Admin“ > &quot;[!DNL Salesforce]&quot; und aktivieren Sie die Aktivitäten, die Sie mit Ihrem Verkaufsteam teilen möchten.
...
* **Verbesserte Leistung bei Verwendung der ANY-Auswahl in einer Smart-Liste**: Es war früher viel langsamer, aber jetzt ist es Zippy!
...
* **Weitere gehostete jQuery-** zur Verwendung auf Landingpages. Auf Landingpages mit benutzerdefiniertem HTML sind alle Arten von dynamischen Funktionen verfügbar. Bitten Sie uns, Ihnen heute zu helfen. Wir werden in Kürze Anleitungen veröffentlichen. Einige Möglichkeiten:
...
* Bessere Unterstützung für **[!DNL Microsoft Internet Explorer 7]**.
...
* **Organisations-Tools in der Lead-Datenbank**:
   ...
   * Leads dauerhaft löschen - insbesondere die „Test“-Leads. Dies wirkt sich überhaupt nicht auf Ihre [!DNL Salesforce] Leads aus.
