...
* **Mit Salesforce Campaign synchronisieren** Synchronisieren Sie Ihre Marketo-Programme mit Salesforce Campaign, einschließlich Mitglieder, Status und Kosten.
...
* **Nativer Opportunity-Support**: Insbesondere für Kunden, die Salesforce nicht als CRM verwenden, haben wir eine Reihe neuer APIs veröffentlicht, mit denen CRUD-Vorgänge (Create, Read, Update, and Delete, Erstellen, Lesen, Aktualisieren und Löschen) für das Opportunity-Objekt in Marketo durchgeführt werden können.
...
* **Browser-Unterstützung**: Unterstützung für Google Chrome und Firefox 6. Neue Versionen dieser Browser sowie Internet Explorer werden ab ihrer Veröffentlichung unterstützt.
...
* **Anpassen von Sternen und Flammen**: Sie können jetzt auswählen, welche Bewertungsfelder Ihre Sterne und Flammen in Sales Insight antreiben.
...
* **WebEx-Adapter**: Nahtlose Verbindung von Smart Events mit WebEx Events (WebEx Event Center erforderlich) und Verwendung von Marketo Landingpages und Formularen zur Erfassung von Registranten und zur automatischen Registrierung in WebEx.
...
* **WebEx-Adapter**: Pushen Sie Registrierungsinformationen über Marketo-Kampagnen an WebEx und rufen Sie Anwesenheitsinformationen nach der Veranstaltung ab.
...
* **Implizite Salesforce-Aktionen**: Flussaktionen in Salesforce übertragen Leads automatisch an Salesforce.
...
* **E-Mail-Editor-Verbesserungen**: Über 20 Fehler wurden behoben, darunter auch Fehler, die speziell für Chrome bestimmt waren.
...
* **Sales Insight Update**: Leistungsverbesserungen und bis zu 200 E-Mails gleichzeitig senden.
...
* **Salesforce-Kampagnen-Token**: Dynamische Zuweisung von Leads zu Salesforce-Kampagnen.
* **Chatter-Integration für Sales Insight**: Wir fügen jetzt interessante Momente in Ihre Chatter-Timeline ein.
* **Zuweisungsregeln für Lead-Partitionen**: Vereinfachen der Partitionszuweisung für neue Salesforce- und API-Leads
