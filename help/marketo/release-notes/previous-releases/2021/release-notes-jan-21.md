...
* **Seite &quot;Mein Konto&quot;aktualisiert**: Lesen Sie die wesentlichen Abonnementinformationen auf der Seite Mein Konto . Benutzer mit beliebigem Zugriff können den Abonnementnamen, die ID des Rechenzentrums und die Munchkin-ID anzeigen.
...
* **[Best-Beta-Verbesserungen](/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/features/marketo-tab/best-bets.md)**: Kontaktieren Sie im Tab Beste Betten schnell Hot Leads, indem Sie sie per E-Mail versenden oder einer Marketo Engage-Kampagne hinzufügen. Zeigen Sie einen Lead in Marketo Engage an oder fügen Sie ihn Ihrer Beobachtungsliste hinzu. Massenaktionen und Sortieroptionen auf der Registerkarte &quot;Beste Betas&quot;sparen Zeit und verbessern die Effizienz des Verkaufsteams.
...
* **Aktualisierungen des Benutzererlebnisses für Sales Connect**: Passen Sie das Rasterlayout von Sales Connect an, indem Sie die Größe der Spalten ändern und neu anordnen. Ihre Anzeigevoreinstellungen werden automatisch gespeichert.
