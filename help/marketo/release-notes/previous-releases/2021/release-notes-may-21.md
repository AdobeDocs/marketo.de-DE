...
* **Sensible Datenfelder in Forms**: Die personenbezogenen Daten des Protect-Kunden können nicht in Adobe Marketo Engage-Formularen angezeigt werden, indem Datenfelder als vertraulich definiert und das Vorfüllen von Formularen für diese Felder eingeschränkt wird. Wenn ein Besucher ein Formular auf der Landingpage anzeigt, zeigen die als vertraulich definierten Felder keine vorausgefüllten Daten an.
