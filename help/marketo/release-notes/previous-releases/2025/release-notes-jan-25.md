...
<table style="table-layout:auto">
 <tbody>
  <tr>
   ...
   <p><img src="assets/note-icon.png" alt="Notizensymbol"> HINWEIS: Um auf den neuen E-Mail-Designer zugreifen zu können, muss Ihr Marketo Engage-Abonnement auf das <a href="https://experienceleague.adobe.com/de/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/adobe-identity-management-overview">Adobe Identity Management System (IMS) migriert </a>. Wenn dies noch nicht geschehen ist und Sie eine Beschleunigung dieses Prozesses wünschen, wenden Sie sich bitte an das Adobe-Accountteam (Ihre Kundenbetreuung) oder an den <a href="https://nation.marketo.com/t5/support/ct-p/Support?profile.language=de">Marketo-Support</a>. Wenden Sie sich an das Adobe-Account-Team , um auf die Funktion Content Accelerator Gen-AI zugreifen zu können.</td>
   <td>Freigegeben</td>
