...
description: Versionshinweise - Dezember 2012 - Marketo-Dokumente - Produktdokumentation
...
Aktivieren Sie die Freigabe von Inhalten für andere, indem Sie in Ihre E-Mails einen Link **Weiterleiten an Freunde** einfügen. Das Hinzufügen neuer Filter und Trigger hilft Ihnen dabei, Ihre Einflussnehmer zu identifizieren, indem Sie sowohl die Benutzer, die eine E-Mail weitergeleitet haben, als auch diejenigen identifizieren, die die weitergeleiteten E-Mails erhalten haben.

Um eine Einladung **Weiterleiten an Freunde** in Ihre E-Mail aufzunehmen, öffnen Sie sie im Editor und fügen Sie das Token `{{system.forwardToFriendLink}}` ein.
...
Gehen Sie zu **Admin** > **Treasure Chest** , um den **Kampagneninspektor** zu aktivieren.
