 ...
 <tbody>
  <tr>
   ...
   <td> </td>
    ...
    <tr>
   <td><strong>Konversative Landingpages</strong>: Betten Sie einen Dynamic Chat-Konversationsfluss direkt in eine Marketo Engage-Landingpage ein, damit Besuchende über Dynamic Chat ein Meeting planen können, ohne ein Formular ausfüllen oder mit einem Chatbot interagieren zu müssen.</td>
...
* Sehen Sie sich [&#x200B; (Januar 2024) Webinar zur Version von &#x200B;](https://engage.marketo.com/2024_January_Release_Webinar_OnDemandPage.html){target="_blank"} an.
