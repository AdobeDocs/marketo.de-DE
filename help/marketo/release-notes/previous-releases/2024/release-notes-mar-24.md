 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> </td>
    ...
    <tr> 
   <td><strong>Konversationsflusslogik neu anordnen</strong>: Beim Marketo Engage von Forms können Sie jetzt die Optionen für den Konversationsfluss neu anordnen, anstatt ihn löschen und wieder hinzufügen zu müssen.</td> 
   <td>Versendet</td>
   <td><a href="/help/marketo/product-docs/demand-generation/dynamic-chat/automated-chat/conversational-flow-settings-for-marketo-engage-forms.md" target="_blank">Konversationsflusseinstellungen für Marketo Engage Forms</a></td>
   </tr>
  <tr> 
...
* **Einstellung des Account Insight Browser-Plug-ins**: Adobe entfernt das Target Account Management [Account Insight Browser-Plug-in](/help/marketo/product-docs/target-account-management/setup-tam/account-insight-plug-in-overview.md){target="_blank"} am 8. April 2024 aus dem Chrome Web Store. Bestehende Benutzende: Sie können das Plug-in weiterhin verwenden, bis Sie Ihre Marketo Engage-Instanz zu Adobe-Identität und -Admin Console migrieren. Diese Änderung **sich nicht auf** anderen TAM-Funktionen/Daten auf Marketo Engage oder den Chrome- und Outlook-E-Mail-Plug-ins aus, die mit Sales Insight funktionieren. [Weitere Informationen](https://nation.marketo.com/t5/product-blogs/marketo-engage-account-insights-browser-plug-in-end-of-life/ba-p/344834){target="_blank"}.
