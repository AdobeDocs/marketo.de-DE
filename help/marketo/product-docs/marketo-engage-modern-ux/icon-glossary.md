...
# Symbolglossar {#new-icon-glossary}

Nachfolgend finden Sie die Symbole für die neue Adobe Marketo Engage-Benutzeroberfläche. Wenn Sie auf die Marketo Classic-Symbole verweisen möchten, finden Sie diese [hier](/help/marketo/getting-started/things-to-know/classic-icon-glossary.md).
...
## Stapel-Kampagnen {#batch-campaigns}
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Zum erneuten Durchlauf eingeplant</td>
  </tr>
  <tr>
   <td><img src="assets/classic-used-by-nurture.png"></td>
   <td><img src="assets/used-by-nurture.png"></td>
   <td>Zum Nurturing verwendet</td>
  </tr>
 </tbody>
</table>

## Auslöser-Kampagnen {#trigger-campaigns}
