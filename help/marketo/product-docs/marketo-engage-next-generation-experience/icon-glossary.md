...
Nachstehend finden Sie die Symbole für die neue Adobe Marketo Engage-Oberfläche. Wenn Sie auf die Marketo Classic-Symbole verweisen müssen, können diese [hier](/help/marketo/getting-started/classic-icon-glossary.md) gefunden werden.
