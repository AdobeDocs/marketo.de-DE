...
>[!NOTE]
>
>Diese Funktion steht nur Trigger-Kampagnen und Benutzern zur Verfügung, denen die Berechtigung [ &quot;Trigger-Kampagnenpriorität bearbeiten&quot;](#grant-priority-override-access) erteilt wurde.
...
1. Wählen Sie unter [!UICONTROL Auf Marketingaktivitäten zugreifen] die Option **[!UICONTROL Trigger-Kampagnenpriorität bearbeiten]** aus. Klicken Sie auf **[!UICONTROL Speichern]**.

   ![](assets/priority-override-for-trigger-campaigns-3.png)

## Priorität aufheben {#override-priority}

1. Suchen Sie Ihre Trigger-Kampagne. Klicken Sie mit der rechten Maustaste darauf und wählen Sie **[!UICONTROL Kampagnenpriorität überschreiben]** aus.

   ![](assets/priority-override-for-trigger-campaigns-4.png)

1. Klicken Sie auf den Regler **[!UICONTROL Kampagnenpriorität überschreiben]** , um die Aktivierung zu aktivieren. Wählen Sie eine neue Prioritätsstufe aus und klicken Sie auf **[!UICONTROL Bestätigen]**.
...
>[!NOTE]
>
>* Sie können die Standardpriorität Ihrer Kampagne in der [!UICONTROL Kampagnenwarteschlange] unter [!UICONTROL Marketingaktivitäten] anzeigen. Um die Ausführungsrate zu steigern, empfehlen wir, die Kampagnenpriorität auf eine Ebene zu setzen, die über der Standardeinstellung liegt.
