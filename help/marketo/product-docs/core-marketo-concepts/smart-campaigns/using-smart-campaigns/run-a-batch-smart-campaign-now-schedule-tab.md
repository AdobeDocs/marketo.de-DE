...
description: Erfahren Sie, wie Sie jetzt eine intelligente Batch-Kampagne über die Registerkarte Zeitplan ausführen. Die Kampagne sofort ausführen, anstatt sie zu planen.
...
1. Stellen Sie sicher **[!UICONTROL dass „Jetzt ausführen]** ausgewählt ist und klicken Sie auf **[!UICONTROL Ausführen]**.

   ![](assets/run-a-batch-smart-campaign-now-schedule-tab-2.png)

1. Bestätigen Sie den Vorgang, indem **[!UICONTROL erneut]** Ausführen“ klicken.
   ...
   >[!NOTE]
   >
   >* [Planen Sie eine Smart-Batch-Kampagne für die spätere Ausführung](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/schedule-a-batch-smart-campaign-to-run-later.md){target="_blank"}
