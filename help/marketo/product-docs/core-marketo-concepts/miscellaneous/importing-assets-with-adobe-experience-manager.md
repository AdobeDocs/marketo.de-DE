...
description: Erfahren Sie, wie Sie AEM-Assets in Marketo Design Studio importieren. Verwenden Sie den Asset-Wähler, um auf Assets zuzugreifen und sie aus Adobe Experience Manager zu importieren.
