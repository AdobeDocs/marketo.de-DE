---
description: Erfahren Sie mehr über Tools zur Datenschutzverwaltung in Marketo Engage für die DSGVO, CCPA und mehr. Handhabung von Zugriffs- und Löschanfragen zur Einhaltung von Vorschriften.
...
* **[!DNL CCPA]** [California Consumer Privacy Act](https://leginfo.legislature.ca.gov/faces/codes_displayText.xhtml?lawCode=CIV&division=3.&title=1.81.5.&part=4.&chapter=&article=) gewährt Einwohnern Kaliforniens Rechte in Bezug auf ihre personenbezogenen Daten und erlegt bestimmten Unternehmen, die in Kalifornien Geschäfte tätigen, Datenschutzverpflichtungen auf.
...
Informationen zum Erstellen von Zugriffs- oder Löschanfragen und deren Verarbeitung finden Sie in [diesem Artikel](/help/marketo/product-docs/core-marketo-concepts/miscellaneous/privacy-requests.md).
