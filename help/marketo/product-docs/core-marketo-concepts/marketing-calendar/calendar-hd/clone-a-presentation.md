...
description: Erfahren Sie, wie Sie eine Marketing-Kalender-Präsentation zur Wiederverwendung klonen. Erstellen Sie eine exakte Kopie, die an verschiedenen Stellen verwendet werden soll.
...
1. Geben Sie einen Namen für die geklonte Präsentation ein und klicken Sie auf **[!UICONTROL Klonen]**.
   ...
   Eine exakte Kopie Ihrer Präsentation ist jetzt vorhanden.
