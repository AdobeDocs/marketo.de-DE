...
description: Erfahren Sie, wie Sie ein Programm und alle zugehörigen Assets klonen. Erstellen Sie eine Kopie in einem Kampagnenordner oder Arbeitsbereich, ohne sie manuell neu zu erstellen.
