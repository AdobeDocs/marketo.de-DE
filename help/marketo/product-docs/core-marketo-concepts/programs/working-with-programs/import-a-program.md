...
description: Erfahren Sie, wie Sie ein Programm in Marketo importieren. Bringen Sie ein Programm aus der Bibliothek oder einer anderen Instanz ein.
...
Sobald der Import abgeschlossen ist, wird eine E-Mail-Bestätigung gesendet.
