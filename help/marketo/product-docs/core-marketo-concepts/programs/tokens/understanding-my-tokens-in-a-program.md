...
# Meine Token in einem Programm {#understanding-my-tokens-in-a-program}
...
Meine Tokens sind benutzerspezifische Variablen, die jeder erstellen kann. Sie werden entweder in Kampagnen- oder Programmen [erstellt](/help/marketo/product-docs/core-marketo-concepts/programs/tokens/managing-my-tokens.md) .
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>Verwenden Sie dieses Token, um Ihren E-Mails und Landingpages eine Kalenderdatei (. <a href="../../../../product-docs/email-marketing/general/functions-in-the-editor/create-a-calendar-event-ics-file.md">ics)</a><a href="../../../../product-docs/email-marketing/general/functions-in-the-editor/create-a-calendar-event-ics-file.md"></a> hinzuzufügen.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Verwenden Sie dieses Token im <a href="../../../../product-docs/core-marketo-concepts/smart-campaigns/flow-actions/use-tokens-in-flow-steps.md">Schritt</a>zum Ändern des Bewertungsablaufs. </td> 
  </tr> 
  <tr> 
...
## Verschachteln von Tokens {#nesting-tokens}
...
* **Übernommenes Token:** Das Token wurde in der Struktur irgendwo in einem Programm oder einem Ordner mit höherer Ebene erstellt.
