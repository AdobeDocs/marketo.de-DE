...
description: Erfahren Sie mehr über lokale Assets in einem Programm. Informationen zur Live-Schaltung von E-Mails, Landingpages und anderen Assets in Programmen
...
Lokale Assets sind die Inhalte, aus denen Ihr Programm besteht. Assets sind anpassbar und ermöglichen Ihnen das Erstellen automatisierter Marketing-Initiativen. Im Folgenden finden Sie die meisten lokalen Assets, die Sie in einem Programm erstellen können:
...
* [Intelligente Listen](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/create-a-smart-list.md){target="_blank"}
...
* [SMS-Nachrichten von Vibes](/help/marketo/product-docs/mobile-marketing/vibes-sms-messages/create-an-sms-message.md){target="_blank"}
