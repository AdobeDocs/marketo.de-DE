...
description: Erfahren Sie, wie Sie die Desktop-Integration von Facebook Lead Ads mit Marketo testen können. Überprüfen Sie die Lead-Anzeigenübermittlungen von der Desktop-Synchronisierung.
...
Nachdem Sie Ihre Lead-Anzeige erstellt haben, sollten Sie sie testen. Führen Sie die folgenden Schritte aus, um dies auf Ihrem Desktop zu tun.
...
1. Sie werden auf einer neuen Registerkarte in Ihrem Browser zu [!DNL Facebook] weitergeleitet. Klicken Sie auf die [!UICONTROL Call to action] in der [!DNL Facebook]-Lead-Anzeigeneinheit.
   ...
   >[!NOTE]
   >
   >In diesem Beispiel wird ein Call to action Weitere Informationen verwendet. Ihr Lead-Anzeigenblock in Call to action ist möglicherweise anders.
...
1. Sie haben das Formular Lead-Anzeige abgeschickt.
