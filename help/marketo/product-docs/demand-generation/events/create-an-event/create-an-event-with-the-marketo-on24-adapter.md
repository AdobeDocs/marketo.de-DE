...
>[!NOTE]
>
>Weitere Informationen finden Sie unter [Dokumentation zur Marketo API](https://developers.marketo.com/documentation/rest/){target="_blank"} Weitere Informationen zu Marketo-APIs.
