---
description: Erfahren Sie, wie Sie die ON24-Integration mit Marketo einrichten. Verbinden Sie Ihr ON24-Konto, damit Sie Webinare und Registrierungsdaten synchronisieren können.
...
1. Wählen Sie die [!UICONTROL Nur API24-Rolle (alle Arbeitsbereiche)] die Sie erstellt haben. Aktivieren Sie das **[!UICONTROL Nur API]**-Kontrollkästchen. Klicken Sie auf **[!UICONTROL Weiter]**.
...
>[!NOTE]
>
>Eine Einladung ist nicht erforderlich für Benutzende, die nur die -API verwenden.
...
1. Suchen Sie den erstellten benutzerdefinierten [!DNL LaunchPoint]-Service und klicken Sie auf [!UICONTROL Details anzeigen].
