...
1. Wählen **Neu erstellen** aus dem Dropdown-Menü aus.
   ...
   >[!NOTE]
   >
   >Die Funktion **Neu erstellen** wird nur in Marketing-Aktivitäten angezeigt und ist nicht in Design Studio verfügbar. In Design Studio sind nur bereits erstellte Videos verfügbar. Sie können jedoch eine Videofreigabe (innerhalb _Programms) erstellen_ indem Sie **Neu** > **Neues lokales Asset** auswählen. Sie können sie dann aus der Dropdown-Liste auswählen, wie hier gezeigt.

1. Geben Sie die URL des YouTube-Videos ein und benennen Sie Ihr Video. Wählen Sie in der Dropdown-Liste Klonen aus **Keine** und klicken Sie dann auf **Einfügen**.
