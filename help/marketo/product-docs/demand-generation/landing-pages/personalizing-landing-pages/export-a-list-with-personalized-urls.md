...
description: Erfahren Sie, wie Sie eine Liste mit personalisierten URLs aus Marketo exportieren. Abrufen einer Empfängerliste mit ihren eindeutigen Landingpage-URLs.
...
1. Wählen Sie die **URL** aus.
   ...
   >[!TIP]
   >
   >Wenn für eine Landingpage mehrere URLs angezeigt werden, liegt das wahrscheinlich daran, dass Sie die URL der Seite zu einem früheren Zeitpunkt geändert und eine Umleitung erstellt haben.

1. Wählen Sie einen **[!UICONTROL Stil]** und klicken Sie auf **[!UICONTROL Exportieren]**.

   ![](assets/image2014-9-18-13-3a37-3a6.png)

1. Wenn der Export abgeschlossen ist, klicken Sie auf den Link **[!UICONTROL Jetzt herunterladen]**, um die Datei zu speichern.
