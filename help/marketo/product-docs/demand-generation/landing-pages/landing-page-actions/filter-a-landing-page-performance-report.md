...
description: Einstiegsseiten-Leistungsbericht filtern - Marketo-Dokumente - Produktdokumentation
title: Einstiegsseiten-Leistungsbericht filtern
...
1. Wählen Sie im Navigationsbaum den Bericht Ihrer Landingpage aus.
...
1. Klicken Sie auf **Einrichtung** und ziehen Sie einen Filter.
   ...
   * **Design Studio-Einstiegsseiten:** Globale Assets, die in Design Studio verwaltet werden.
   * **Einstiegsseiten für Marketingaktivitäten:** Lokale Assets in Programmen auf der Registerkarte Marketingaktivitäten .
   * **Archivierte Landingpages:** Inaktive, veraltete Landingpages.

1. Wählen Sie die Ordner und Landingpages aus, die in den Bericht aufgenommen werden sollen.
