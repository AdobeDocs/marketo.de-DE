...
description: Formularübermittlungs-Schaltflächentext ändern - Marketo-Dokumente - Produktdokumentation
...
1. Wählen Sie die Schaltfläche aus und ändern Sie die **Titel**.
