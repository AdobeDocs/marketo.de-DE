...
Gehen Sie wie folgt vor, um das Dynamic Chat einzurichten.
...
1. Nachdem Dynamic Chat für Ihre Marketo-Instanz aktiviert wurde, erhält der vorgesehene Systemadministrator eine Begrüßungs-E-Mail. Klicken Sie in dieser E-Mail auf **Erste Schritte**.
...
Als Nächstes ist es Zeit, [Dynamic Chat mit Marketo zu verbinden](/help/marketo/product-docs/demand-generation/dynamic-chat/integrations/adobe-marketo-engage.md){target="_blank"}.
