...
<table>
  <tbody>
    ...
    <tr>
      <td>D1, D2, D3 usw.</td>
      <td>Stellt mehrere Dialogfelder dar, bei denen D1 Dialog 1 ist</td>
    </tr>
    <tr>
      <td>P1, P2, P3 usw.</td>
...
<table>
  <tr>
    ...
    <tr>
      ...
      <td>D1 sollte auf WP1 aufgelöst werden<br/>D2 sollte auf WP2 aufgelöst werden</td>
      <td>
        <p>Die Anzahl der Trigger für D1 sollte um 1 erhöht werden </p>
    ...
    <tr>
      ...
      <td>
        <p>Der Trigger, die Interaktion und die Anzahl der Abgeschlossenen für D1 sollten um 1 erhöht werden. </p>
        <p>Die Anzahl der Trigger für D2 sollte um 1 erhöht werden </p>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <p>Der Trigger, der eingestellt ist, sollte die Anzahl der Abgeschlossenen für D1 um 1 erhöht werden </p>
    ...
    <tr>
      ...
      <td>Die Anzahl der Trigger für D1 sollte erst nach 30 Sekunden erhöht werden</td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <p>D1 wurde für WP1 mit einem Trigger von 50 % Scroll verwendet </p>
        <p>V1 besucht WP1</p>
      </td>
      <td>
        <p>D1 sollte aufgelöst werden, wird jedoch nicht auf V1 ausgelöst </p>
    ...
    <tr>
      <td>
        ...
        <p>D2 für WP1 mit 2 Priorität und Ereignis "page scroll %"von 50 %</p>
