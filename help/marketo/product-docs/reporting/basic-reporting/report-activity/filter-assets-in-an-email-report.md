...
1. Klicken Sie auf die Registerkarte **Einrichtung** und ziehen Sie über einen Filter.
   ...
   * **E-Mails zu Marketingaktivitäten**: Lokale Assets in Programmen auf der Registerkarte Marketingaktivitäten .
   * **Archivierte E-Mails**: Inaktive, veraltete E-Mails.

1. Wählen Sie die Ordner und E-Mails aus, die in den Bericht aufgenommen werden sollen.
...
>[!MORELIKETHIS]
>
>[Filtern von Assets in E-Mail-Berichten einer Kampagne](/help/marketo/product-docs/reporting/basic-reporting/report-activity/filter-assets-in-a-campaign-email-reports.md)
