...
Für die Analyse verfügbare Kennzahlen sind im Allgemeinen Zahlen und werden durch blaue Punkte dargestellt. Bemaßungen sind Attribute, die unterschiedliche Ansichten der Kennzahlen wiedergeben und durch gelbe Punkte dargestellt werden.
...
Der Wert der Akquise eines bestimmten Leads ändert sich im Laufe der Zeit. Es ist null, bis der Lead einen Kauf tätigt. Sie kann dann mit zusätzlichen Käufen zunehmen.

Erfolgsbezogene Maßnahmen rechnen alle Programme an, die zum Fortschritt eines Leads im Hinblick auf eine Bestellung beitragen.
...
## Dimensionen der Opportunity-Analyse des Programms (gelbe Punkte) {#program-opportunity-analysis-dimensions-yellow-dots}
