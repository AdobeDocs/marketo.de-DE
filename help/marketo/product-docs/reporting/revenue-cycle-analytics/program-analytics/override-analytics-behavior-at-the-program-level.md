...
Sie können das Analyseverhalten auf Admin-Ebene für Kanal](/help/marketo/product-docs/reporting/revenue-cycle-analytics/program-analytics/make-a-program-without-a-period-cost-available-in-revenue-explorer-and-analyzers.md) festlegen, es kann aber auch auf Programm-Ebene außer Kraft gesetzt werden. [ So:
...
1. Ziehen Sie unter der Registerkarte **Setup** das Analytics-Verhalten in die Arbeitsfläche.
