...
>[!PREREQUISITES]
>
>Der Administrator muss über eine Marketo-E-Mail-Add-In-Lizenz für [ verfügen.](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/issue-a-marketo-email-add-in-license.md)
...
1. Klicken Sie auf **Enterprise Key anzeigen**.

   ![](assets/image2016-7-25-14-3a35-3a38.png)

1. Kopieren Sie den Outlook Enterprise-Lizenzschlüssel, fügen Sie ihn zusammen mit [diesem Link](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/marketo-outlook-plugin-installation-by-it.md) in eine E-Mail ein und senden Sie ihn zur Remote-Installation an Ihre IT-Abteilung.
