---
description: Salesforce-Konfiguration - Marketo-Dokumente - Produktdokumentation
...
## Salesforce-Anpassungspaket deinstallieren (Classic) {#uninstall-salesforce-customization-package-classic}

Deinstallieren Sie das Marketo Sales Connect-Package von Ihrem Salesforce-Konto, sobald Sie mit der Verwendung des MSI-Aktionspakets beginnen.

**Felder für Verkaufsverbindung aus Seitenlayout entfernen**
...
**Entfernen von Verkaufsverbindungs-Schaltflächen aus Seitenlayouts**
...
**Entfernen von Verkaufsverbindungs-Feldern aus dem Abschnitt &quot;Aktivitätsverlauf&quot;**
...
1. Wählen Sie anschließend im Bereich Ausgewählte Felder die Felder für die Verkaufsverbindung aus und klicken Sie auf den Pfeil Entfernen . Klicken **OK** wann geschehen.
...
**Entfernen Sie die Aktionsschaltflächen &quot;Sales Connect&quot;-Massenaktion aus der Lead-Listenansicht.**
...
**MSC-Konfiguration für Kontakte entfernen**
...
**MSC-Konfiguration für Opportunity entfernen**
...
**MSC-Konfiguration für Konto entfernen**
...
**Marketo Sales Outbox entfernen**
...
**Anpassungsdetails für Sales Connect**
