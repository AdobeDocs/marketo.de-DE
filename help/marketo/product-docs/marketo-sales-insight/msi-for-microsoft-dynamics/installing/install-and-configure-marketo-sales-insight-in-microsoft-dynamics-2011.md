...
>[!PREREQUISITES]
>
>Schließen Sie Ihre [Marketing-Microsoft-Integration](http://docs.marketo.com/x/DoA2)ab.
>
...
1. Klicken Sie auf **Importieren** ( ![](assets/image2015-5-4-10-3a45-3a44.png)).
   ...
   >
   >
   >Sie sollten die Marketing-Lösung bereits [installiert und konfiguriert](install-and-configure-marketo-sales-insight-in-microsoft-dynamics-2011.md) haben, bevor Sie fortfahren.

1. Klicken Sie auf **Durchsuchen**. Wählen Sie die von Ihnen [heruntergeladene](download-the-marketo-sales-insight-solution-for-microsoft-dynamics.md)Marketo Sales Insight-Lösung aus. Klicken Sie auf **Weiter**.
...
1. Wählen Sie **in der Struktur die Option &quot;Marketo-API-Konfiguration** &quot;.
