...
description: Erfahren Sie, wie Sie eine Marketo-Verkaufs-E-Mail von Microsoft Dynamics aus senden. Verfassen und Senden getrackter E-Mails über das MSI-Bedienfeld in Dynamics.
...
1. Einen oder mehrere Leads auswählen.
...
1. Fügen Sie einen Betreff hinzu, erstellen Sie Ihre E-Mail und klicken Sie auf **[!UICONTROL E-Mail senden]**. (Wählen Sie eine Vorlage aus, falls Sie eine benötigen.)
   ...
   >[!TIP]
   >
   >Sie können zuerst auf **Test-E-Mail**. Die E-Mail wird an Sie gesendet (primäre E-Mail-Adresse in Microsoft Dynamics), bevor Sie die eigentliche E-Mail versenden.
