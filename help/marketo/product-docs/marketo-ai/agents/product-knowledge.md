...
Produktkenntnisse bieten Ihnen On-Demand-Zugriff auf Marketo-Know-how, ohne die Plattform verlassen zu müssen. Stellen Sie eine Frage in einfacher Sprache, und Marketo AI nutzt die offiziellen Adobe-Dokumente zur Beantwortung.
...
**Grundlegendes zum Status** ProgrammteilnehmerInnen: Ein Kampagnen-Manager stellt nach einem Webinar fest, dass die Status der Programmteilnehmer nicht den Erwartungen entsprechen. Sie fragen: „Was ist der Unterschied zwischen dem Status „Angemeldet“ und dem Status „Anwesend“ in einem Marketo-Veranstaltungsprogramm und wie werden sie eingerichtet?“ Marketo AI erklärt, wie jeder Status festgelegt wird, wie der typische Ablauf für Webinar-Programme abläuft und wie Status manuell aktualisiert werden, wenn die Integration sie nicht automatisch festlegt.
...
* Die Kenntnisse von Marketo AI spiegeln die dokumentierten Anleitungen und Best Practices von Adobe wider. Aktuelle Funktionsveröffentlichungen finden Sie in den Versionshinweisen zu Adobe Marketo Engage direkt.
