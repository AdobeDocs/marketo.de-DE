...
Sie können Ihre [Personenberichte](https://docs.marketo.com/display/docs/basic+reporting) nach jedem [Segment](https://docs.marketo.com/display/docs/basic+reporting) gruppieren, das [in Ihren Segmenten](create-a-segmentation.md) definiert ist.
...
1. Wählen Sie den Personenbericht aus der Navigationsstruktur aus.
   ...
   >
   >
   >Erfahren Sie mehr über Personenberichte und andere Berichtstypen im tiefen Tauchgang [Grundlegender Berichte](https://docs.marketo.com/display/docs/basic+reporting).
...
1. Klicken Sie auf die Registerkarte **Setup** und klicken Sie mit der Dublette auf **Personen gruppieren nach**.
   ...
   >[!NOTE]
   >
   >Sie können auch [Personendaten nach Person oder Firma gruppieren.](https://docs.marketo.com/display/DOCS/Group+Person+Reports+by+Attribute)
...
>**Tieftauchen**
>
>Weitere Informationen zu Segmenten und deren Erstellung und Verwaltung finden Sie unter [Segmentierung](https://docs.marketo.com/display/docs/segmentation+and+snippets) Tiefgang.
