...
1. Wählen Sie in der Dropdown-Liste &quot; **E-Mail-Editor/Snippet-Editor** &quot;die Option <div> oder &quot;Ohne&quot;und klicken Sie auf **Speichern**. <div> in diesem Beispiel verwendet.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>&lt;div class="mktEditable"&gt;<br>&lt;p&gt;Text läuft hier&lt;/p&gt;<br>&lt;/div&gt;</p></td> 
   <td><p>&lt;div class="mktEditable"&gt;<br>&lt;div&gt;Text geht hier&lt;/div&gt;<br>&lt;/div&gt;</p></td> 
   <td><p>&lt;div class="mktEditable"&gt;<br>Text geht hier<br>&lt;/div&gt;</p></td> 
  </tr> 
 </tbody> 
</table>
...
>[!TIP]
>
>Sie können auch das Stammblock-Element des Landingpages-Editors ändern, indem Sie die gleichen Schritte ausführen, aber in Schritt 4 auf die Dropdown-Liste **Landingpage-Editor** statt E-Mail/Snippet-Editor klicken.
...
>[!TIP]
>
>Sie bearbeiten HTML und Text auf separaten Bildschirmen. Klicken Sie auf der Registerkarte &quot; **Text** &quot;auf &quot;Aus HTML **** kopieren&quot;und dann auf &quot; **Speichern** &quot;, damit der Text mit Ihrem HTML-Code übereinstimmt.
...
1. Wählen Sie in der Dropdownliste **Landingpage-Editor** die Option <p> oder &quot;Ohne&quot;und klicken Sie auf **Speichern**. <p> in diesem Beispiel verwendet.
