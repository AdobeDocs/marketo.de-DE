...
>[!NOTE]
>
>Nur gespeicherte E-Mails können referenziert werden. Im neuen E-Mail-Designer gibt es keinen Status &quot;Genehmigt&quot;.

>[!MORELIKETHIS]
>
>[E-Mail-Vorlagen](/help/marketo/product-docs/email-marketing/general/beta-new-email-designer/email-templates.md){target="_blank"}: Erfahren Sie, wie Sie eine E-Mail-Vorlage im neuen Designer erstellen, entwerfen und darauf zugreifen.
