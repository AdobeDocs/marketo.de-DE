...
Verwenden Sie die **[!UICONTROL Über die Marke]**, um die Kernidentität Ihrer Marke zu ermitteln und ihren Zweck, ihre Persönlichkeit, ihren Slogan und andere definierende Attribute zu umreißen.
...
Nun können Sie Ihre Marke weiter personalisieren oder [veröffentlichen](/help/marketo/product-docs/email-marketing/email-designer/brands/manage-brands.md#create-brand-kit).
