...
description: Erfahren Sie mehr über die Funktionsunterschiede zwischen E-Mail-Editor 2.0 und der neuen E-Mail-Designer. Verwenden Sie die Tabelle, um die Verfügbarkeit der Funktionen zu vergleichen.
...
<tbody>
  ...
  <tr>
    <td>Generieren von Inhalt</td>
    <td>Möglichkeit, Betreffzeile, Teil des Inhalts oder gesamte E-Mail über <a href="/help/marketo/product-docs/email-marketing/email-designer/generate-content.md" target="_blank">Generative KI</a>-Modelle zu generieren.</td>
  ...
  <tr>
    <td>Marken-Designs</td>
    <td>Möglichkeit zur <a href="/help/marketo/product-docs/email-marketing/email-designer/brands/brand-themes.md" target="_blank"> (Anwendung genehmigter </a>) im gesamten Unternehmen, um Konsistenz in Elementen wie Stil, Farbe, Schriftgröße usw. sicherzustellen.</td>
    <td>Nicht verfügbar</td>
    <td>Verfügbar</td>
  </tr>
  <tr>
