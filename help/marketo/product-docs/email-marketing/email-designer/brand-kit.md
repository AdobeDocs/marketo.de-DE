...
>[!AVAILABILITY]
>
>Sie müssen der [Benutzervereinbarung“ zustimmen](https://www.adobe.com/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html){target="_blank"} bevor Sie den KI-Assistenten in Adobe Marketo Engage verwenden können. Weitere Informationen erhalten Sie vom Adobe Account Team (Ihrem Account Manager).
...
Um auf das Menü **[!UICONTROL Marken]** in [!DNL Adobe Marketo Engage] zugreifen zu können, müssen Benutzenden die Berechtigungen **[!UICONTROL Marken-Kit verwalten]** oder **[!UICONTROL KI-Assistenten aktivieren]** gewährt werden. LINK „WEITERE INFORMATIONEN“
...
1. Öffnen Sie im Dashboard **[!UICONTROL Marken]** das erweiterte Menü, indem Sie auf das LEERE Symbol klicken, um Folgendes auszuführen:
...
Ihre Markenrichtlinien sind jetzt über das Dropdown **[!UICONTROL Marke]** im Menü des KI-Assistenten verfügbar, sodass Inhalte und Assets generiert werden können, die Ihren Spezifikationen entsprechen. Weitere Informationen zum KI-Assistenten - LINK
...
1. Klicken Sie auf der Registerkarte **[!UICONTROL Visueller Inhalt]** auf LEER , um eine Richtlinie, einen Ausschluss oder ein Beispiel hinzuzufügen.
