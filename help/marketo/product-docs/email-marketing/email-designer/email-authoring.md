---
description: Erfahren Sie, wie Sie E-Mails in der E-Mail-Designer erstellen, personalisieren und in der Vorschau anzeigen. Verwenden Sie Design Studio- oder E-Mail-Programme, um E-Mails zu erstellen.
...
Erfahren Sie, wie Sie E-Mails in der E-Mail-Designer erstellen, personalisieren und in der Vorschau anzeigen.
...
1. Wählen Sie in der Struktur **E-Mails (Neu)**.
...
1. Sie haben zwei Möglichkeiten, eine neue E-Mail zu erstellen. Klicken Sie mit der rechten Maustaste auf den Namen Ihres E-Mail-Programms und wählen Sie **Neues lokales Asset**, oder klicken Sie auf die Schaltfläche **+Neue E-Mail** im Feld E-Mail im Dashboard. In diesem Beispiel wird die erste Option verwendet.
...
1. Klicken Sie in der soeben erstellten E-Mail auf **E-Mail-Inhalt bearbeiten**.
...
1. Wählen Sie entweder mit einem Design beginnen (empfohlen) oder von Grund auf neu mit manuellem Stil erstellen.

   >[!NOTE]
   >
   >Für E-Mails, die mit manuellem Stil erstellt wurden, können keine mit Designs erstellten Fragmente verwendet werden
