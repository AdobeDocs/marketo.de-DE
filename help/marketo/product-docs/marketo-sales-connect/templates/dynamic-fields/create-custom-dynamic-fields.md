...
1. Befolgen Sie den [normalen CSV-Upload-Vorgang](http://docs.marketo.com/x/HIPS)und stoppen Sie den Vorgang im Anzeigebereich &quot;Feldzuordnung&quot;.
1. Wählen Sie anstelle eines der vordefinierten Felder **Hinzufügen ein neues benutzerdefiniertes Feld** aus der Dropdownliste.
...
1. [Erstellen Sie eine Vorlage](http://docs.marketo.com/x/OCDG) und klicken Sie wie gewohnt auf die Schaltfläche &quot; **Dynamische Felder** &quot;.
