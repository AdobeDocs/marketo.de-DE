...
>[!NOTE]
>
>Die Benutzer **können** den Inhalt einer E-Mail zum Zeitpunkt des Versands oder beim Starten einer Kampagne weiterhin bearbeiten.

1. Klicken Sie in Sales Connect auf das Symbol Einstellungen und wählen Sie **Einstellungen**.
...
1. Blättern Sie nach unten zur Inhaltsbegrenzung. Wenn Sie einen der Schieberegler aktivieren, *wird die Fähigkeit Ihrer Teammitglieder, Vorlagen und/oder Kampagnen zu erstellen/bearbeiten, deaktiviert* .
