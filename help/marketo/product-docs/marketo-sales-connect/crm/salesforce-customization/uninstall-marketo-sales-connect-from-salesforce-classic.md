---
description: Erfahren Sie, wie Sie Marketo Sales Connect von Salesforce Classic deinstallieren. Entfernen Sie Sales Connect-Anpassungen und -Schaltflächen aus Classic.
...
# Deinstallieren von Marketo Sales Connect aus Salesforce Classic {#uninstall-marketo-sales-connect-from-salesforce-classic}
...
1. Wählen Sie die [!DNL Sales Connect] Felder im Bereich [!UICONTROL Ausgewählte Felder] aus und klicken Sie auf den [!UICONTROL Entfernen]. Klicken Sie auf **[!UICONTROL OK]**, wenn Sie fertig sind.
   ...
   >[!NOTE]
   >
   >Die Abkürzung MSE _is_ [!DNL Sales Connect]. Es ist nur der vorherige Name, &quot;Marketo Sales Engage“.
