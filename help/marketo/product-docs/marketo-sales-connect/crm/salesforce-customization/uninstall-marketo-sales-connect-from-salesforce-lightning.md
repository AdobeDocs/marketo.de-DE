...
# Deinstallieren von Marketo Sales Connect aus Salesforce Lightning {#uninstall-marketo-sales-connect-from-salesforce-lightning}
...
1. Wählen Sie im Bereich Ausgewählte Felder die Option Sales Connect-Felder aus und klicken Sie auf den Pfeil Entfernen . Klicken Sie auf **OK**, wenn Sie fertig sind.
   ...
   >[!NOTE]
   >
   >Die Abkürzung MSE _is_ Sales Connect. Es ist nur der vorherige Name, &quot;Marketo Sales Engage“.
