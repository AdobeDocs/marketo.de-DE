...
description: Erfahren Sie, wie Sie verhindern können, dass eine sekundäre Gmail-Adresse mit Sales Connect integriert wird. Verwenden Sie nur Ihre primäre E-Mail für das Plug-in.
