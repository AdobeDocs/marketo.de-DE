...
description: Erfahren Sie, was eingerichtet werden muss, bevor Sie Push- und In-App-Nachrichten erstellen. Abrufen von Admin- und Entwicklerschritten, SDK und benutzerdefinierten Ereignisanleitungen.
...
>[!TIP]
>
>Für Marketo-Admins ist es einfach, zu überprüfen, ob Ihre Push-Konfiguration verifiziert ist. Geh einfach [hier](/help/marketo/product-docs/mobile-marketing/admin/verify-push-configuration.md).
