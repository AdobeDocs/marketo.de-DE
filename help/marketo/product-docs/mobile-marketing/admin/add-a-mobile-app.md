...
description: Erfahren Sie, wie Sie eine Mobile App zu Marketo hinzufügen, um Push-Benachrichtigungen zu senden. Benennen Sie die App und wählen Sie Sandbox oder Produktionsumgebung aus.
...
1. Klicken Sie **[!UICONTROL Mobile Apps &amp; Devices]**.

   ![](assets/image2016-1-12-15-3a42-3a30.png)

1. Klicken Sie auf **[!UICONTROL Neue App]**.
...
1. Geben Sie einen Namen ein. Wählen Sie in **[!UICONTROL Dropdown]** Typ“ den verwendeten Umgebungstyp aus: [!UICONTROL Sandbox] oder [!UICONTROL Produktion]. Klicken Sie auf **[!UICONTROL Speichern]**.
   ...
   >[!NOTE]
   >
   >Es wird empfohlen, ein [!UICONTROL Produktion] -Benachrichtigungszertifikat in einer [!UICONTROL Produktion]-Umgebung zu verwenden. Ein [!UICONTROL Sandbox]-Zertifikat wird problemlos in einer [!UICONTROL Produktions]Umgebung installiert, Sie erhalten jedoch keine Benachrichtigungen. Wenden Sie sich bei Fragen zu Ihrer Umgebung oder Ihrem Benachrichtigungszertifikat an Ihren Marketo-Administrator oder den Entwickler Ihrer mobilen Apps.
