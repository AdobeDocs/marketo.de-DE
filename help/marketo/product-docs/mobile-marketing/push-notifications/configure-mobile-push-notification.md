...
Die in Push-Benachrichtigungen konfigurierten Umleitungs-URIs unterstützen in ihnen Marketo-Token. Gilt nur für Launch-App-URLs.

Beispielformat:

* Vorhandenes Anwendungsformat:
  `com.onboardmd://financing?FirstName={{lead.First Name}}&City={{lead.City}}`

* Mit Fallback-Werten formatieren:
