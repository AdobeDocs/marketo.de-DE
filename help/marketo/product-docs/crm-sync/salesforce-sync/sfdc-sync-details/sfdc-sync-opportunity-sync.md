...
Die Synchronisation erfolgt in eine Richtung: von Salesforce zu Marketo Engage. Aktualisierungen der Opportunities in Salesforce werden mit Marketo synchronisiert.
...
Nein, das kannst du nicht. Die Änderungen an einer Opportunity in Salesforce werden automatisch mit Marketo synchronisiert.
...
Nein, Marketo unterstützt nur eine Währung. Der Opportunity-Betrag wird von Salesforce synchronisiert, aber die Währung ist die [Standardwährung](/help/marketo/product-docs/administration/settings/set-default-location-settings-for-a-subscription.md#set-the-default-currency-settings-for-a-subscription){target="_blank"} in Ihrem Marketo-Abonnement.
...
Sie können eine Liste von Opportunitys auf der Registerkarte **Opportunity-Info** auf der Seite [Personendetails](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/using-the-person-detail-page.md){target="_blank"} anzeigen.
...
>
>Erstellen Sie einfach ein neues Feld im Opportunity-Objekt in Salesforce und es wird automatisch zu einer Einschränkung!
