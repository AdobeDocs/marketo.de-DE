...
description: Erfahren Sie, wie die Opportunity-Synchronisierung von Salesforce nach Marketo funktioniert. Erfahren Sie, wie Opportunities synchronisiert, mit Kontakten verknüpft und Opportunity-Trigger und -Filter verwendet werden.
...
# SFDC-Synchronisierung: Opportunity-Synchronisierung {#sfdc-sync-opportunity-sync}
...
>[!NOTE]
>
>Die [Anmeldeinformationen, die Sie in Marketo für eingeben [!DNL Salesforce]](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/enterprise-unlimited-edition/step-2-of-3-create-a-salesforce-user-for-marketo-enterprise-unlimited.md) werden verwendet, um Daten zu synchronisieren. Es werden nur Daten einbezogen, auf die mit diesen Anmeldedaten zugegriffen werden kann.
