...
Ja, verwenden Sie die [Person mit SFDC synchronisieren](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/sync-person-to-sfdc.md) Flussaktion. Dadurch wird ein Lead in Salesforce erstellt, wenn der Lead nicht vorhanden ist.
