...
Die **[channel](/help/marketo/product-docs/administration/tags/create-a-program-channel.md){target="_blank"}** und **[period cost](/help/marketo/product-docs/core-marketo-concepts/programs/working-with-programs/understanding-period-costs.md){target="_blank"}** in Marketo werden mit Salesforce als Kampagnentyp **und als** tatsächliche Kosten **synchronisiert.** Diese Synchronisation erfolgt von Marketo nach Salesforce auf **einen Weg**.

Marketo **Programmmitglieder** und ihr **[Status der Progression](/help/marketo/product-docs/core-marketo-concepts/programs/creating-programs/understanding-program-membership.md){target="_blank"}** werden mit den Status der **Salesforce-Kampagnenmitglieder** und **Kampagnenmitglieder** synchronisiert. Dies ist eine **bidirektionale Synchronisation**, sodass alle Änderungen, die in Marketo oder Salesforce vorgenommen werden, in beiden Systemen übernommen werden.
...
Ja, verwenden Sie die Aktion [Zu SFDC-Kampagnenfluss hinzufügen](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/add-to-sfdc-campaign.md){target="_blank"}. Wenn diese Person nicht in Salesforce vorhanden ist, erstellt Marketo sie in Salesforce und fügt sie dann der Kampagne hinzu.
...
Ja, verwenden Sie die Aktion [Aus SFDC Campaign-Fluss entfernen](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/remove-from-sfdc-campaign.md){target="_blank"}.

## Kann ich den Status von Kampagnenmitgliedern mit Marketo ändern? {#can-i-change-campaign-member-status-using-marketo}

Ja, verwenden Sie die Aktion &quot;[Status in SFDC Campaign Flow ändern&quot;](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/change-status-in-sfdc-campaign.md){target="_blank"}.
...
>[!NOTE]
>
>Wenn Ihre Salesforce-Kampagne und das zugeordnete Marketo-Programm inkompatible Programmstatus aufweisen, erhalten Sie möglicherweise eine Fehlermeldung. Es wird empfohlen, [vor der Synchronisierung mit dem Programmstatus abzugleichen.](/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/how-to-match-program-statuses-and-salesforce-campaign-statuses-prior-to-sync.md){target="_blank"}
...
>* [Einrichten eines Marketo-Synchronisierungsbenutzers für Marketing-Benutzer](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/optional-steps/enable-disable-campaign-sync/make-marketo-sync-user-a-marketing-user.md){target="_blank"}
