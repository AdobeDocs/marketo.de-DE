...
# SFDC-Synchronisierung: Kampagne synchronisieren {#sfdc-sync-campaign-sync}
...
Die ** [Kanal](../../../../product-docs/administration/tags/create-a-program-channel.md) **und ** [Periode Kosten](../../../../product-docs/core-marketo-concepts/programs/working-with-programs/understanding-period-costs.md)** in Marketo synchronisieren mit Salesforce als **Kampagne Typ** und **tatsächliche Kosten**. Diese Synchronisierung ist **eine Möglichkeit**, von Marketo bis Salesforce.

Marketo- **Programm-Mitglieder** und ihre ** [Progressionsstatus](../../../../product-docs/core-marketo-concepts/programs/creating-programs/understanding-program-membership.md)** werden mit den **Salesforce-Kampagnen** und den Mitgliedsstatuen **der** Kampagne synchronisiert. Dies ist eine **bidirektionale** **Synchronisierung**, sodass alle Änderungen, die in Marketo oder Salesforce vorgenommen werden, in beiden Systemen übernommen werden.
...
Ja, verwenden Sie die [Hinzufügen zum SFDC-Kampagnen-Fluss-Aktion](../../../../product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/add-to-sfdc-campaign.md). Wenn diese Person nicht in Salesforce vorhanden ist, erstellt Marketo sie in Salesforce und fügt sie dann der Kampagne hinzu.
...
Ja, verwenden Sie die [Flussaktion](../../../../product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/remove-from-sfdc-campaign.md)&quot;Aus SFDC-Kampagne entfernen&quot;.

## Kann ich den Status eines Kampagne-Mitglieds mit Marketo ändern? {#can-i-change-campaign-member-status-using-marketo}

Ja, verwenden Sie die Aktion &quot;Status [ändern&quot;im Fluss](../../../../product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/change-status-in-sfdc-campaign.md)der SFDC-Kampagne.
...
>[!NOTE]
>
>Wenn Ihre Salesforce-Kampagne und das zugeordnete Marketo-Programm inkompatible Programm-Status haben, erhalten Sie möglicherweise eine Fehlermeldung. Es wird empfohlen, dass Sie vor der Synchronisierung [mit dem Programm-Status übereinstimmen](sfdc-errors/how-to-match-program-statuses-and-salesforce-campaign-statuses-prior-to-sync.md).
