---
description: Erfahren Sie, wie Sie die Client-App auf Microsoft Dynamics für die ROPC-Verbindung einrichten. Registrieren Sie die App in Azure AD und generieren Sie ein Client-Geheimnis für die Marketo-Synchronisierung.
...
1. Notieren Sie sich die Anwendungs-ID (ClientId). Geben Sie sie später in Marketo ein.
...
1. Fügen Sie eine Beschreibung des Client-Geheimnisses hinzu und klicken Sie auf **[!UICONTROL Hinzufügen]**.
   ...
   >[!CAUTION]
   >
   >Beachten Sie den Wert des Client-Geheimnisses (siehe Screenshot unten), da er nur einmal angezeigt wird und nicht erneut abgerufen werden kann.
