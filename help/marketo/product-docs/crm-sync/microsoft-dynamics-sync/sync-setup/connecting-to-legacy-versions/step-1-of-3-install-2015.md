...
Bevor Sie Microsoft Dynamics 2015 On-Premises mit Marketo Engage synchronisieren können, müssen Sie zunächst die Marketo-Lösung in Dynamics installieren.
...
>[!PREREQUISITES]
>
>Wenn Sie Microsoft Dynamics On-Premise verwenden, müssen Sie über die Konfiguration von [Internet-Facing-Bereitstellung](https://www.microsoft.com/en-us/download/confirmation.aspx?id=41701){target="_blank"} (IFD) mit [Active Directory Federation Services](https://msdn.microsoft.com/en-us/library/bb897402.aspx){target="_blank"} 2.0+ (ADFS) verfügen. Hinweis: Das IFD-Dokument wird beim Klicken auf den Link automatisch heruntergeladen.
>
...
1. Klicken Sie auf **[!UICONTROL Durchsuchen]** und wählen Sie die Lösung aus, die Sie [heruntergeladen haben](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md). Klicken Sie auf **[!UICONTROL Weiter]**.
...
1. Wählen Sie die Marketo-Lösung aus und klicken Sie auf **[!UICONTROL Publish All Customizations]**.
   ...
   >[!MORELIKETHIS]
   >
   >[Installieren von Marketo für Microsoft Dynamics 2015 On-Premises Schritt 2 vom 3.1}](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-2-of-3-set-up-2015.md){target="_blank"}
