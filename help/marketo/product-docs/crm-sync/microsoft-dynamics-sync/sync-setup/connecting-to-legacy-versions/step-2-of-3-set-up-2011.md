...
Einige letzte Konfigurationsschritte bleiben bestehen, bevor mit dem nächsten Artikel fortgefahren wird.
...
## Bevor Sie mit Schritt 3 fortfahren {#before-proceeding-to-step}
    ...
    * Führen Sie den Prozess [Validate [!DNL Microsoft Dynamics] Sync](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/validate-microsoft-dynamics-sync.md) aus. Es stellt sicher, dass die Ersteinstellungen korrekt durchgeführt wurden.
    * Melden Sie sich bei Marketo Sync User in. [!DNL Microsoft Dynamics] .
