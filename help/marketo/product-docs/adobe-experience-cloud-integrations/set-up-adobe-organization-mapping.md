...
1. Geben Sie Ihre [Adobe IMS Org ID](https://experienceleague.adobe.com/docs/control-panel/using/faq.html){target="_blank"}) ein und klicken Sie auf **[!UICONTROL OK]**.
