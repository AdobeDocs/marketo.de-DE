...
Ansicht der ICP-Indikatoren, die Sie beim [Anpassen des Modells](/help/marketo/product-docs/target-account-management/account-profiling/account-profiling-ranking-and-tuning.md#model-tuning) für den Export ausgewählt haben.
