...
description: Kennwortsicherheitseinstellungen ändern - Marketo Docs - Produktdokumentation
...
1. Legen Sie **Ablauf** fest. Für diese Funktion müssen Benutzer ihre Kennwörter nach einer bestimmten Zeit automatisch zurücksetzen. Dies schließt auch den Admin-Benutzer ein.
   ...
   >[!CAUTION]
   >
   >Vorhandene Benutzer werden nicht über die Änderungen benachrichtigt. Stellen Sie zunächst **Ablauf** auf 30 Tage ein, um sicherzustellen, dass alle Benutzer die neuen Einstellungen übernommen haben, und ändern Sie dann wieder zu Ihrer ursprünglichen Kadenz.
