...
Wenn Sie Zugriff auf mehrere Marketo-Abonnements haben und bestätigen möchten, welches Sie verwenden, geben Sie jedem einen eindeutigen Namen. Dieser Name wird dann oben auf der Abonnementseite angezeigt.
