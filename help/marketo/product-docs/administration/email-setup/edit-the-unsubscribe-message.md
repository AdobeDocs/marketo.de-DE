...
Beim Versand von Marketing-E-Mails ([operationell](/help/marketo/product-docs/email-marketing/general/functions-in-the-editor/make-an-email-operational.md)) werden Text und Links zur Abmeldung unten angehängt. Sie können die Standardeinstellungen ändern. So geht&#39;s.
...
1. HTML Bearbeiten Sie die Versionen **[!UICONTROL Abo beenden]** und **[!UICONTROL Text abmelden]** nach Ihren Wünschen und klicken Sie auf **[!UICONTROL Änderungen speichern]**.
...
>[!TIP]
>
>Sie können die Position der Abmelde-HTML in Ihrer E-Mail mit „Token[ anpassen](/help/marketo/product-docs/email-marketing/general/using-tokens/add-a-system-token-as-a-link-in-an-email.md).
