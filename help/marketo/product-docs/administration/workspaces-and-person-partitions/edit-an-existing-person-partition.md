...
1. Wählen Sie auf der Registerkarte **Personenpartitionen** die zu bearbeitende Personenpartition aus und klicken Sie auf **Personenpartition** bearbeiten.

   ![](assets/two-5.png)

1. Geben Sie den **Namen** der Benutzerpartition ein, die **Arbeitsbereiche **sie gehören, und klicken Sie auf **Speichern**.
