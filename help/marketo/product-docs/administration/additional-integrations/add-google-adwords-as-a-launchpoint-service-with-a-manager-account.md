...
1. Wählen Sie Ihr Konto, das mit **Google AdWords** verknüpft ist.
...
1. Attribute für die Konvertierung auf den **ersten Klick** oder den **letzten Klick**.
   ...
   >[!NOTE]
   >
   >[Damit diese Funktion funktioniert, muss das automatische Tagging](https://support.google.com/adwords/answer/1752125?hl=en) aktiviert sein. Es muss in AdWords aktiviert werden.
