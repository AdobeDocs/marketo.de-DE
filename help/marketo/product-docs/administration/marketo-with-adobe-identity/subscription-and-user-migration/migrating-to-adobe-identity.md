...
Wenn Adobe die Benutzermigration eines Abonnements plant, erhalten Marketo Engage-Produkt-Administratoren Zugriff auf die Migrationskonsole, die im Navigationsmenü im Admin-Bereich unter dem Integrationsthema zu finden ist.
...
Der erste Abschnitt behandelt den E-Mail-Verifizierungsstatus von Benutzern innerhalb des Abonnements.

Der zweite Abschnitt bezieht sich auf den Status der Benutzermigration und -aktivierung (d. h. Migration und Berechtigung zum Marketo Engage-Produkt) der Benutzer innerhalb des Abonnements.

Der dritte Abschnitt bezieht sich auf den Migrationsstatus des Abonnements.
...
Die Bestätigungs-E-Mail kann von einem Administrator auf der Registerkarte Benutzermigration der Migrationskonsole und der Registerkarte Benutzer und Rollen im Marketo Admin-Bereich oder vom Benutzer in den Kontoeinstellungen erneut gesendet werden. Wie Einladungs-E-Mails läuft der Link in der Bestätigungs-E-Mail in 3 Tagen ab. Weitere Informationen zur E-Mail-Verifizierung finden Sie in der Community . &lt;nation.marketo.com> und in der Dokumentation zur E-Mail-Verifizierung &lt; https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/users-and-roles/email-verification.html?lang=en>.

WICHTIG

Wenn ein Marketo Engage-Benutzer seine E-Mail-Adresse nicht verifiziert, kann er nicht in eine Adobe ID migriert werden und verliert nach Abschluss der Migration für das Abonnement den Zugriff auf das Marketo-Abonnement. Um nach Abschluss der Benutzermigration wieder Zugriff zu erhalten, muss ein Marketo-Produktadministrator sie als neuen Benutzer hinzufügen.
...
Der für die Migration verantwortliche Administrator muss die Migrationsbestätigung durch Klicken auf die Schaltfläche &quot;Migration abschließen&quot;abschließen. Sie werden aufgefordert, den Abschluss der Migration zu bestätigen.
...
Durch Auswahl der Schaltfläche &quot;Ablauf erweitern&quot;wird das Datum auf eine Woche später aktualisiert. Administratoren können ihre Gültigkeit bis zu dreimal verlängern.

SCREENSHOT

SCREENSHOT

Die Auslieferung durch Adobe erfolgt, nachdem der Kunde die Migration bis zum Ablaufdatum nicht abgeschlossen hat.
...
Die E-Mail-Verifizierung ist erforderlich, damit ein Benutzer in eine Adobe ID migriert werden kann. Wenn Benutzer vorhanden sind, die ihre E-Mail-Adresse nicht verifiziert haben und migriert werden müssen, kann der Administrator die Bestätigungs-E-Mail erneut an den Benutzer senden, um sie Trigger. Wenn Sie einen nicht verifizierten Benutzer auswählen, wird die Schaltfläche &quot;E-Mail überprüfen&quot;aktiviert und Sie werden aufgefordert, die E-Mail-Adresse anzuzeigen, die gesendet wurde.

SCREENSHOT

Sobald der Administrator auf die Schaltfläche &quot;E-Mail überprüfen&quot;klickt, erhält er eine Benachrichtigung, dass die E-Mail gesendet wurde.
...
Um das Überspringen eines Benutzers aufzuheben, kann der Administrator den gewünschten Benutzer auswählen. Die Schaltfläche &quot;Migration aufheben&quot;wird aktiviert. Wenn Sie auf die Schaltfläche &quot;Migration aufheben&quot;klicken, wird die Seite aktualisiert.  Der Überprüfungsstatus des ausgewählten Benutzers wird auf den aktuellen Status aktualisiert, entweder &quot;Verifiziert&quot;oder &quot;Nicht verifiziert&quot;, und der Migrationsstatus des Benutzers wird auf &quot;Nicht gestartet&quot;aktualisiert.
...
Migrieren von Marketo-Benutzern zu Adobe-IDs

Für Kunden, die während des Benutzermigrationsprozesses mehr Kontrolle benötigen, unterstützt Marketo einen Self-Service-Ansatz für Abonnements mit 75 oder mehr Benutzern. Marketo-Produktadministratoren können Benutzer auswählen, die in Batches migriert werden sollen, oder alle berechtigten Benutzer gleichzeitig auswählen. Sobald Benutzer ausgewählt sind, haben Administratoren die Möglichkeit, &quot;Jetzt migrieren&quot;oder &quot;Migration planen&quot;für einen späteren Zeitpunkt festzulegen, wodurch Administratoren die ultimative Flexibilität und Kontrolle darüber erhalten, welche Benutzer migriert werden und wann. Administratoren erhalten außerdem die Option &quot;Alle Benutzer migrieren&quot;in einem Abonnement.

Beispielsweise könnte ein Administrator eine Gruppe von &quot;Power&quot;-Benutzern auswählen, die zuerst migriert werden sollen. Nach erfolgreichem Abschluss der Benutzermigration können sie verschiedene Gruppen auswählen, die auf Elementen wie Workspace oder Geschäftsfunktion oder Rolle basieren, um die Batch-Benutzermigration fortzusetzen. Oder sie können sich entscheiden, alle anderen Benutzer in den Abonnements nach dem Erfolg des ersten Batches zu migrieren. Das Ziel besteht darin, die Adobe-IDs so flexibel wie möglich für Benutzer bereitzustellen.

Alle Benutzermigrationen erfolgen gleichzeitig und sollten innerhalb von 60 Sekunden erfolgreich abgeschlossen werden. Während die Benutzermigration für einen bestimmten Benutzer stattfindet, kann der Benutzer den Zugriff für bis zu 1 Minute verlieren, und zwar nur, wenn der Benutzer bei der Anwendung angemeldet ist. Nach Abschluss der Benutzermigration erhält der Benutzer eine E-Mail, wie er sich mit einer Adobe-Identität bei Marketo Engage anmelden kann. Der Benutzer muss die Einladung über den Button-Link in der E-Mail annehmen. Nachdem der Benutzer die Einladung angenommen hat, sollte er sich mit einer Adobe ID anmelden. Anweisungen zur Anmeldung bei Marketo Engage mit einem Adobe ID finden Sie hier. &lt; https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/user-sign-in-with-adobe-id.html>

SCREENSHOT

Benutzermigrationen werden unabhängig voneinander verarbeitet. Wenn also die Benutzermigration fehlschlägt, verarbeitet Adobe weiterhin andere Benutzermigrationen. Wenn ein Benutzermigrationsfehler auftritt, ist für einen Administrator keine Aktion erforderlich. Adobe Engineering wird daran arbeiten, das Problem so bald wie möglich zu lösen. Der Administrator wird per E-Mail über den Fehler benachrichtigt und darauf hingewiesen, dass Adobe sofort daran arbeitet, das Problem zu beheben. Wenn die Migration eines Benutzers fehlschlägt und dieser Benutzer bei der Marketo Engage angemeldet ist, kann der Benutzer den Zugriff bis zu 2 Minuten lang verlieren, während erneute Migrationsversuche unternommen werden.  Wenn die Migration eines Benutzers fehlschlägt, kann der Benutzer weiterhin mit seiner Marketo-Identität auf die Marketo Engage zugreifen, bis er eine E-Mail-Benachrichtigung erhält, dass die Migration erfolgreich war. Zudem wird er aufgefordert, sich bei einer Adobe ID anzumelden.

SCREENSHOT

Jetzt migrieren

Ein Administrator kann einen oder mehrere Benutzer auswählen, die bei Bedarf migriert werden sollen. Dadurch wird die Benutzermigration sofort Trigger. Um einen oder mehrere Benutzer zu migrieren, wählt der Administrator die gewünschten Benutzer aus und die Schaltfläche &quot;Jetzt migrieren&quot;wird aktiviert.
...
Ein Administrator kann einen oder mehrere Benutzer auswählen, um die Migration zu einem späteren Zeitpunkt zu planen. Um die Migration für einen oder mehrere Benutzer zu planen, wählt der Administrator die gewünschten Benutzer aus und die Schaltfläche &quot;Migration planen&quot;wird aktiviert.

SCREENSHOT

NOTE

Die Schaltfläche &quot;Migration planen&quot;ist nur aktiv, wenn alle ausgewählten Benutzer einen Verifizierungsstatus haben.

Wenn Sie auf die Schaltfläche &quot;Migration planen&quot;klicken, wird der Administrator aufgefordert, das gewünschte Migrationsdatum für die ausgewählten Benutzer auszuwählen. Der Administrator kann nur Daten auswählen, die vor dem Migrationsablaufdatum des Abonnements liegen. Sobald der Administrator dies bestätigt hat, wird geplant, die Verarbeitung der Benutzermigration(en) am ausgewählten Datum zu starten.
...
Wenn Sie auf die Schaltfläche &quot;Alle Benutzer migrieren&quot;klicken, wird der Administrator aufgefordert, die Migration aller berechtigten Benutzer zu bestätigen. Sobald der Administrator dies bestätigt hat, werden die Benutzermigrationen so bald wie möglich verarbeitet.
