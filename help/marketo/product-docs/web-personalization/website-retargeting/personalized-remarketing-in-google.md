...
1. Melden Sie sich bei Ihren Google Analytics an. Klicken **Admin**, **Konto**, **Eigenschaft**. Klicken Sie auf **Zielgruppendefinitionen** und **Zielgruppen**.

   ![](assets/remarketing-ga-screenshots.jpg)

1. Klicken **+Neue Zielgruppe**.
...
>* Ereigniskategorie: Segment, Insightera-CTA, RTP-Remarketing
...
1. Eingabe **Name der segmentierten Zielgruppe** (wie es in RTP angezeigt wird).
1. Klicken **Anwenden**.
...
1. Eingabe **Name der Branche** (z. B. Finanzdienstleistungen, Bildung...).
1. Klicken **Anwenden**.
1. Geben Sie eine **Zielgruppenname**. Klicken **Speichern**.
