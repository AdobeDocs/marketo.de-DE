...
description: Erfahren Sie, wie Sie in Marketo Engage mithilfe von „Create a new account-list create-a-new-account-list“ eine neue Kontoliste erstellen. Verwenden Sie dieses Handbuch, um Ihren nächsten Schritt abzuschließen.
