...
1. Geh ins **Dashboard!** Klicken Sie auf die entsprechende Webeigenschaft.
...
1. Füllen Sie die folgenden Felder aus
   ...
   1. Name: **Marketo RTP**
   1. Bedingungen (Zusammenbruch): Auslöserregel am - **Anfang der Seite**
...
1. Fügen Sie das RTP JavaScript-Tag ein.
   ...
   >[!CAUTION]
   >
   >Achten Sie darauf, alle Tags zu entfernen und nur das Skript selbst zu belassen (nein `<script type='text/javascript'>` , `</script>` )

1. Klicken Sie im Skript-Editor auf Code **speichern** und im Regeleditor auf Regel **speichern** .

1. Suchen Sie im Regelbedienfeld die Regel zum Laden der Seite &quot;Marketo RTP&quot;und wählen Sie im Dropdownmenü **Aktionen** die Option Regeln **aktivieren**.
