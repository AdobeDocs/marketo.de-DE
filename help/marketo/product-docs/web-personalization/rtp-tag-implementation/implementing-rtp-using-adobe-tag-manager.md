...
description: Erfahren Sie mehr über die Implementierung von RTP mit dem Adobe Tag Manager in Marketo Engage, einschließlich der Implementierung von RTP mit dem Adobe Tag. Verwenden Sie dieses Handbuch, um Ihren nächsten Schritt abzuschließen.
title: Implementieren von RTP mit dem Adobe Tag Manager
...
# Implementieren von RTP mit dem Adobe Tag Manager {#implementing-rtp-using-adobe-tag-manager}
