...
Die neuesten Informationen finden Sie auf dieser Seite als Lesezeichen. Um Statusaktualisierungen zu Beginn und nach Abschluss der Migration zu erhalten, [ Sie ](https://experienceleague.adobe.com/en/docs/marketo/using/getting-started/things-to-know/system-status-notifications){target="_blank"}. Sie können während Ihres Migrationsfensters auch https://status.adobe.com/ besuchen.
