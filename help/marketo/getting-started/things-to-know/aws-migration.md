...
Für Statusaktualisierungen können Sie [Abonnieren, um sie zu erhalten](https://experienceleague.adobe.com/de/docs/marketo/using/getting-started/things-to-know/system-status-notifications){target="_blank"} zu Beginn und nach Abschluss der Migration zugreifen. Sie können [https://status.adobe.com/de-de/](https://status.adobe.com/de){target="_blank"} während Ihres Migrationsfensters auch aufrufen.
