...
>[!NOTE]
>
>Sie können diese Checkliste auch herunterladen. [zusammen mit einer Liste von Best Practices](/help/marketo/getting-started/inheriting-a-marketo-engage-instance/assets/adobe-marketo-engage-new-instance-admin-checklist.xlsx) für Ihre neue Instanz und aktivieren Sie die Schritte, während Sie fortfahren.
