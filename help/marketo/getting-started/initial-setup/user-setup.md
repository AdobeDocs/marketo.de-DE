...
<tbody>
  ...
  <tr>
    ...
    <td><li>Weisen Sie alle gewünschten Benutzenden dem Marketo Engage-Produktprofil <a href="https://experienceleague.adobe.com/de/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/admin-setup#create-a-product-profile">Adobe Admin Console</a> zu.</li>
    <ul>
