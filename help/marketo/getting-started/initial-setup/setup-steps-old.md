...
>[!TIP]
>
>Wenn Sie [Diese Checkliste ausdrucken](/help/marketo/getting-started/initial-setup/setup-checklist.md){target="_blank"}, können Sie die Elemente bei ihrem Abschluss abwählen.
...
Navigieren Sie zu **[!UICONTROL Admin]** Bereich.
