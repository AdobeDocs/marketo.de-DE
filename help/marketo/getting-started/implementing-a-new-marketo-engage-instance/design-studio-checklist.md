...
<tbody>
  ...
  <tr>
    <td>Datenschutz und Compliance</td>
    <td><li>Formulare beibehalten <a href="https://business.adobe.com/resources/ebooks/the-gdpr-and-the-marketer.html" target="_blank">Die Datenschutz-Grundverordnung (DSGVO)</a> konform.</li></td>
  </tr>
  <tr>
...
<tbody>
  ...
  <tr>
    <td>Datenschutz und Compliance</td>
    <td><li><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/general/functions-in-the-editor/add-a-snippet-to-an-email" target="_blank">Snippets hinzufügen</a> in Ihre E-Mail-Vorlagen verwenden, um wiederverwendbare Bausteine wie Copyright-Jahr, globaler Speicherort und Compliance-spezifische Sprache zu steuern.</li>
    <li><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/general/using-tokens/add-an-email-script-token-to-your-email" target="_blank">Token hinzufügen</a> , um den Inhalt basierend auf der Zielgruppe zu personalisieren.</li></td>
  </tr>
</tbody>
</table>
