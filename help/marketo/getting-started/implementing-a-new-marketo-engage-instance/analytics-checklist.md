---
description: Richten Sie den Abschnitt Analytics für Ihre neue Marketo Engage-Instanz ein.
...
# Best Practices für neue Instanzen: Checkliste für Analysen {#new-instance-best-practices-analytics-checklist}
...
<tbody>
  <tr>
    ...
    <li><a href="https://experienceleague.adobe.com/de/docs/marketo/using/product-docs/reporting/basic-reporting/editing-reports/change-a-report-time-frame">Verwenden eines relevanten Zeitrahmens</a> (z. B. TTD, letzte 90 Tage usw.) damit der Bericht eine genaue Ansicht der standardmäßigen E-Mail-Interaktions- und Zustellbarkeitsmetriken bietet.</li>
  ...
  <tr>
    ...
    <p><img src="assets/tip-icon.png" alt="Notizensymbol"> TIPP: Erstellen Sie in der Datenbank Smart Lists für die benutzerdefinierten Spalten, die Sie anstelle von Marketing-Aktivitäten zum Bericht „Personen-Performance“ hinzufügen möchten, damit Sie den Namen der Smart List richtig und deutlich sehen können, wenn er im Bericht ausgewählt wird.</td>
  </tr>
  <tr>
    <td>Programmleistungsbericht</td>
  ...
  <tr>
    <td>Leistungsbericht für Landingpage</td>
  ...
  <tr>
    <td>Aktivitätsbericht zu Web-Seiten</td>
...
Einige Marketo Engage-Berichte werden am besten als lokale Assets innerhalb bestimmter Programme in Marketing-Aktivitäten bereitgestellt, da sie in der Regel in einem eingeschränkteren Satz von Programmen und Assets verwendet werden. Sie sollten grundlegende Berichte einrichten, z. B.:
...
<tbody>
  <tr>
    <td>Leistungsbericht zu E-Mail-Links</td>
  ...
  <tr>
    ...
    <td><li>Erstellen Sie den <a href="https://experienceleague.adobe.com/de/docs/marketo/using/product-docs/reporting/basic-reporting/report-types/campaign-activity-report" target="_blank">Kampagnenaktivitätsbericht</a> und wählen Sie einen Zeitraum innerhalb Ihres Betriebsordners unter „Marketing-Aktivitäten“.</li>
