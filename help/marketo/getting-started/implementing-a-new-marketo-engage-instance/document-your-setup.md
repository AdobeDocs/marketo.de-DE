...
<tbody>
  <tr>
    <td>Listenimport</td>
    <td><li>Erfassen Sie eine Liste der Datenquellen, aus denen Datensätze abgerufen (in <a href="https://experienceleague.adobe.com/de/docs/marketo/using/getting-started/quick-wins/import-a-list-of-people" target="_blank"> importiert) </a>.</li>
