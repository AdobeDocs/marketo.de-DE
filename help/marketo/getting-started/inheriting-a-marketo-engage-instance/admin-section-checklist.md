...
<br/> Wenn nicht, suchen Sie in Ihrem Posteingang nach der <a href="/help/marketo/product-docs/administration/marketo-with-adobe-identity/admin-setup.md#initial-setup" target="_blank">Begrüßungs-E</a>Mail) und akzeptieren Sie die Einladung zur Aktivierung Ihrer Adobe ID.</li></td>
  </tr>
  <tr>
   <td>Produktprofil</td>
...
<br/> Wenn ja, müssen Sie <a href="https://www.adobe.io/apis/experienceplatform/umapi-new.html" target="_blank">Adobe IMS-APIs) verwenden</a> um künftig Anwender einzuladen, zu aktualisieren und zu löschen.</li>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <p>
   <li>Wie viele Benutzer gibt es?</li>
<li>Gibt es Benutzer, die entfernt <a href="/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md#remove-a-user" target="_blank"> sollen</a>?</li>
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   ...
   <br/> Wenn nicht, sollten Sie eine hinzufügen. Es wird empfohlen, die Smart Campaign-Beschränkungen auf 25 % der Datenbank zu begrenzen, um Überkommunikation zu vermeiden oder die gesamte Datenbank in Workflows zu verarbeiten. Dies schützt nicht nur Ihre Marke, sondern auch die Leistung Ihrer Instanz.</li></td>
  </tr>
 </tbody>
</table>
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   ...
   <br/> Klicken Sie auf <a href="/help/marketo/product-docs/administration/field-management/export-a-list-of-all-marketo-api-field-names.md" target="_blank">Feldnamen exportieren</a>, um eine Liste Ihrer Felder, benutzerdefinierten Felder und ihrer API-Namen zu überprüfen.</li>
...
<br/> Wählen <a href="/help/marketo/product-docs/administration/field-management/export-used-by-data-for-a-field.md" target="_blank">Exportieren verwendet von</a> in der Dropdown-Liste Feldaktionen aus, um die zugehörigen Assets eines Felds zu überprüfen.</li>
...
<br/> Wenn nicht, sollten Sie dies implementieren.</li>
...
<br/> Wenn ja, sollten Sie verstehen, warum sie es sind.</li></td>
  </tr>
  <tr>
...
<p><img src="assets/note-icon.png" alt="Notizensymbol"> HINWEIS: Wenden Sie sich an den Adobe-Support, um benutzerdefinierte Synchronisierungsfilter zu identifizieren, oder fordern Sie die Implementierung einer benutzerdefinierten Synchronisierungsregel an.</li></td>
  </tr>
  <tr>
   <td>Landingpages</td>
...
<br/> Wenn nicht, suchen Sie in Ihrem Posteingang nach der Begrüßungs-E-Mail und akzeptieren Sie die Einladung zum Einrichten Ihrer Adobe ID.</li>
