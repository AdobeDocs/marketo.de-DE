...
# Erste Einrichtungsaufgaben für Marketo Engage{#initial-setup-tasks-for-marketo-engage}

Beim ersten Einrichten Ihrer brandneuen Adobe Marketo Engage-Instanz gibt es eine Reihe von Aufgaben, die Sie ausführen müssen/die wir Ihnen dringend empfehlen, damit Sie die Funktionen nutzen können.

Nach dieser ersten Einrichtung lesen Sie bitte unsere [Best Practices für eine neue Marketo Engage-Instanz](/help/marketo/temp-getting-started-section/temp-best-practice-checklists/where-to-start.md) , um Ihre Investition optimal zu nutzen und sich für langfristigen Erfolg zu etablieren.

## Aufgabe 1: Domänen der Zulassungsliste {#allowlist-domains}
...
## Aufgabe 2: Erstellen von DNS-Aufzeichnungen für Landingpages und E-Mails {#step-create-dns-records-for-landing-pages-and-email}
...
## Aufgabe 3: Zulassungsliste der Marketo-IPs {#step-allowlist-marketo-ips}
...
## Aufgabe 4: Einrichten von SPF und DKIM {#step-set-up-spf-and-dkim}
...
## Aufgabe 5: Einrichten von DMARC {#set-up-dmarc}
...
## Aufgabe 6: Einrichten von MX-Datensätzen für Ihre Domäne {#step-set-up-mx-records-for-your-domain}
